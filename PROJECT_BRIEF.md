...
- Production is not yet upgraded: legacy hash deployment URLs still execute old APIs. Lock their access and verify a complete write pause before installing 0031–0034. Maintenance artifact `ops/maintenance` is tested on staging, not yet applied to production.
