...
Use `C:\Users\DinhTungPC\AGENTS.md` for the global short workflow and `./AGENTS.md` for repo-specific fast-path checks. The rest of this file is project context only.
...
## Local Environment (.dev.vars)
  ...
  MOMO_IPN_URL (required HTTPS public callback), MOMO_CREATE_ENDPOINT, MOMO_QUERY_ENDPOINT (optional; sandbox defaults)
...
This project is indexed by GitNexus as **qhboypho-main** (966 symbols, 3060 relationships, 74 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/qhboypho-main/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/qhboypho-main/context` | Codebase overview, check index freshness |
| `gitnexus://repo/qhboypho-main/clusters` | All functional areas |
| `gitnexus://repo/qhboypho-main/processes` | All execution flows |
| `gitnexus://repo/qhboypho-main/process/{name}` | Step-by-step execution trace |
