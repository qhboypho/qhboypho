...
<title>QH Clothes Ã¢â‚¬â€œ Phong CÃƒÂ¡ch ThÃ¡Â»Âi Trang Hot Trend</title>
<meta name="description" content="ThÃ¡Â»Âi trang hot trend cho giÃ¡Â»â€ºi trÃ¡ÂºÂ», cÃ¡ÂºÂ­p nhÃ¡ÂºÂ­p cÃƒÂ¡c mÃ¡ÂºÂ«u mÃ¡Â»â€ºi vÃƒÂ  thÃ¡Â»â€¹nh hÃƒÂ nh nhÃ¡ÂºÂ¥t. Mua sÃ¡ÂºÂ¯m phong cÃƒÂ¡ch, dÃ¡ÂºÂ«n Ã„â€˜Ã¡ÂºÂ§u xu hÃ†Â°Ã¡Â»â€ºng, giÃƒÂ¡ cÃ¡Â»Â±c chÃ¡ÂºÂ¥t tÃ¡ÂºÂ¡i QH Clothes.">
<meta name="keywords" content="QH Boypho, QH Clothes, boypho, girlpho, HiÃ¡ÂºÂ¿u QuÃ¡Â»Â³nh, thÃ¡Â»Âi trang hot trend, thÃ¡Â»Âi trang giÃ¡Â»â€ºi trÃ¡ÂºÂ», quÃ¡ÂºÂ§n ÃƒÂ¡o nam nÃ¡Â»Â¯, local brand, ÃƒÂ¡o thun unisex, ÃƒÂ¡o khoÃƒÂ¡c nam nÃ¡Â»Â¯, mÃ¡ÂºÂ«u mÃ¡Â»â€ºi thÃ¡Â»â€¹nh hÃƒÂ nh">
<meta name="author" content="QH Clothes">
<meta name="robots" content="index, follow">
<meta property="og:title" content="QH Clothes Ã¢â‚¬â€œ Phong CÃƒÂ¡ch ThÃ¡Â»Âi Trang Hot Trend">
<meta property="og:description" content="ThÃ¡Â»Âi trang hot trend cho giÃ¡Â»â€ºi trÃ¡ÂºÂ», cÃ¡ÂºÂ­p nhÃ¡ÂºÂ­p cÃƒÂ¡c mÃ¡ÂºÂ«u mÃ¡Â»â€ºi vÃƒÂ  thÃ¡Â»â€¹nh hÃƒÂ nh nhÃ¡ÂºÂ¥t.">
<meta property="og:image" content="/qh-logo.png">
<meta property="og:type" content="website">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="QH Clothes Ã¢â‚¬â€œ Phong CÃƒÂ¡ch ThÃ¡Â»Âi Trang Hot Trend">
<meta name="twitter:description" content="ThÃ¡Â»Âi trang hot trend cho giÃ¡Â»â€ºi trÃ¡ÂºÂ», cÃ¡ÂºÂ­p nhÃ¡ÂºÂ­p cÃƒÂ¡c mÃ¡ÂºÂ«u mÃ¡Â»â€ºi vÃƒÂ  thÃ¡Â»â€¹nh hÃƒÂ nh nhÃ¡ÂºÂ¥t.">
...
<style>
  ...
  * { font-family: 'Inter', sans-serif; }
  ...
  /* Ã¢â€â‚¬Ã¢â€â‚¬ HERO BANNERS EXPAND Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
  #heroBannersWrapper {
    position: relative;
    cursor: pointer;
  }
...
<nav class="navbar-blur fixed top-0 left-0 right-0 z-50 border-b border-white/10">
  <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
    ...
    <div class="hidden md:flex items-center gap-6 text-sm text-gray-300">
      <a href="#products" class="hover:text-pink-400 transition">SÃ¡ÂºÂ£n phÃ¡ÂºÂ©m</a>
      <a href="#about" class="hover:text-pink-400 transition">VÃ¡Â»Â chÃƒÂºng tÃƒÂ´i</a>
      <a href="#contact" class="hover:text-pink-400 transition">LiÃƒÂªn hÃ¡Â»â€¡</a>
    </div>
    <div class="flex items-center gap-3">
      ...
      <button onclick="openTopupModal()" id="walletNavBtn" class="hidden items-center gap-1.5 bg-white/10 hover:bg-white/20 text-white px-3 py-1.5 rounded-xl transition text-xs font-medium">
        ...
        <span id="walletBalanceNav">0Ã„â€˜</span>
      </button>
      <!-- User Avatar / Login -->
  ...
  <div id="mobileMenu" class="hidden md:hidden border-t border-white/10 py-4 px-4 flex flex-col gap-3">
    <a href="#products" class="text-gray-300 hover:text-pink-400" onclick="toggleMobileMenu()">SÃ¡ÂºÂ£n phÃ¡ÂºÂ©m</a>
    <a href="#about" class="text-gray-300 hover:text-pink-400" onclick="toggleMobileMenu()">VÃ¡Â»Â chÃƒÂºng tÃƒÂ´i</a>
    <a href="#contact" class="text-gray-300 hover:text-pink-400" onclick="toggleMobileMenu()">LiÃƒÂªn hÃ¡Â»â€¡</a>
  </div>
</nav>
...
<section class="gradient-hero min-h-screen flex items-center pt-16" id="hero">
  <div class="max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
    <div>
      <p class="text-pink-400 font-medium tracking-widest uppercase text-sm mb-4">BÃ¡Â»â„¢ sÃ†Â°u tÃ¡ÂºÂ­p mÃ¡Â»â€ºi 2026</p>
      <h1 class="font-display text-5xl md:text-6xl text-white font-bold leading-tight mb-6">
        Phong CÃƒÂ¡ch<br><span style="background:linear-gradient(135deg,#e84393,#f39c12);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent">KhÃƒÂ´ng GiÃ¡Â»â€ºi HÃ¡ÂºÂ¡n</span>
      </h1>
      <p class="text-gray-300 text-lg mb-8 leading-relaxed">KhÃƒÂ¡m phÃƒÂ¡ bÃ¡Â»â„¢ sÃ†Â°u tÃ¡ÂºÂ­p thÃ¡Â»Âi trang cao cÃ¡ÂºÂ¥p dÃƒÂ nh cho cÃ¡ÂºÂ£ nam lÃ¡ÂºÂ«n nÃ¡Â»Â¯. ChÃ¡ÂºÂ¥t lÃ†Â°Ã¡Â»Â£ng vÃ¡ÂºÂ£i premium, thiÃ¡ÂºÂ¿t kÃ¡ÂºÂ¿ tinh tÃ¡ÂºÂ¿ Ã¢â‚¬â€œ thÃ¡Â»Æ’ hiÃ¡Â»â€¡n cÃƒÂ¡ tÃƒÂ­nh cÃ¡Â»Â§a bÃ¡ÂºÂ¡n.</p>
      <div class="flex gap-4 flex-wrap">
        <a href="#products" class="btn-primary text-white px-8 py-3 rounded-full font-semibold">
          <i class="fas fa-shopping-bag mr-2"></i>Mua sÃ¡ÂºÂ¯m ngay
        </a>
        <a href="#about" class="border border-white/30 text-white px-8 py-3 rounded-full font-semibold hover:bg-white/10 transition">
          KhÃƒÂ¡m phÃƒÂ¡ thÃƒÂªm
        </a>
      </div>
      <div class="mt-12 grid grid-cols-3 gap-6">
        <div class="text-center"><p class="text-3xl font-bold text-white">500+</p><p class="text-gray-400 text-sm">SÃ¡ÂºÂ£n phÃ¡ÂºÂ©m</p></div>
        <div class="text-center"><p class="text-3xl font-bold text-white">10K+</p><p class="text-gray-400 text-sm">KhÃƒÂ¡ch hÃƒÂ ng</p></div>
        <div class="text-center"><p class="text-3xl font-bold text-white">4.9Ã¢Ëœâ€¦</p><p class="text-gray-400 text-sm">Ã„ÂÃƒÂ¡nh giÃƒÂ¡</p></div>
      </div>
    </div>
    <div class="flex justify-center" id="heroBannersWrapper">
      <!-- Collapsed / stacked state -->
      <div id="heroBannersCollapsed" title="Click Ã„â€˜Ã¡Â»Æ’ xem thÃƒÂªm">
    ...
    <div id="heroBannersExpanded" onclick="handleBannerOverlayClick(event)">
      <p id="heroBannersExpandedTitle">Ã°Å¸â€Â¥ Ã„Âang thÃ¡Â»â€¹nh hÃƒÂ nh</p>
      <p id="heroBannersExpandedSubtitle" class="text-white/70 text-xs md:text-sm text-center mb-4">Ã„ÂÃƒÂ¢y lÃƒÂ  nhÃ¡Â»Â¯ng sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m hot nhÃ¡ÂºÂ¥t vÃƒÂ  Ã„â€˜ang Ã„â€˜Ã†Â°Ã¡Â»Â£c Ã„â€˜Ã¡ÂºÂ·t mua nhiÃ¡Â»Âu nhÃ¡ÂºÂ¥t Ã¡Â»Å¸ thÃ¡Â»Âi Ã„â€˜iÃ¡Â»Æ’m hiÃ¡Â»â€¡n tÃ¡ÂºÂ¡i.</p>
...
<section class="sticky top-16 z-40 bg-white shadow-sm border-b" id="filterBar">
  <div class="max-w-7xl mx-auto px-4 py-3 flex gap-3 overflow-x-auto scrollbar-none items-center">
    <span class="text-sm text-gray-500 whitespace-nowrap font-medium">LÃ¡Â»Âc:</span>
    <button class="filter-btn active whitespace-nowrap px-4 py-1.5 rounded-full border text-sm font-medium transition" data-cat="all" onclick="filterProducts('all',this)">TÃ¡ÂºÂ¥t cÃ¡ÂºÂ£</button>
    ...
    <button class="filter-btn whitespace-nowrap px-4 py-1.5 rounded-full border text-sm font-medium transition text-gray-600 hover:border-red-400" data-cat="female" onclick="filterProducts('female',this)">NÃ¡Â»Â¯</button>
    <div class="flex-1"></div>
    <div class="relative">
      <input type="text" id="searchInput" placeholder="TÃƒÂ¬m sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m..." 
...
<section class="max-w-7xl mx-auto px-4 py-16" id="products">
  <div class="text-center mb-12">
    <p class="text-pink-500 font-medium tracking-widest uppercase text-sm">KhÃƒÂ¡m phÃƒÂ¡ ngay</p>
    <h2 class="font-display text-4xl font-bold text-gray-900 mt-2">SÃ¡ÂºÂ£n PhÃ¡ÂºÂ©m NÃ¡Â»â€¢i BÃ¡ÂºÂ­t</h2>
    <p class="text-gray-500 mt-3">NhÃ¡Â»Â¯ng thiÃ¡ÂºÂ¿t kÃ¡ÂºÂ¿ Ã„â€˜Ã†Â°Ã¡Â»Â£c yÃƒÂªu thÃƒÂ­ch nhÃ¡ÂºÂ¥t tÃ¡Â»Â« bÃ¡Â»â„¢ sÃ†Â°u tÃ¡ÂºÂ­p cÃ¡Â»Â§a chÃƒÂºng tÃƒÂ´i</p>
  </div>
  ...
  <div id="emptyState" class="hidden text-center py-20">
    ...
    <p class="text-gray-400 text-lg">KhÃƒÂ´ng tÃƒÂ¬m thÃ¡ÂºÂ¥y sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m nÃƒÂ o</p>
  </div>
</section>
...
<section class="bg-white py-16" id="about">
  <div class="max-w-7xl mx-auto px-4">
    <div class="grid md:grid-cols-4 gap-8 text-center">
      <div class="p-6"><div class="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mx-auto mb-4"><i class="fas fa-truck text-pink-500 text-2xl"></i></div><h3 class="font-semibold text-gray-800 mb-2">Giao hÃƒÂ ng toÃƒÂ n quÃ¡Â»â€˜c</h3><p class="text-gray-500 text-sm">Giao tÃ¡ÂºÂ­n nÃ†Â¡i, nhanh chÃƒÂ³ng, an toÃƒÂ n</p></div>
      <div class="p-6"><div class="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mx-auto mb-4"><i class="fas fa-shield-alt text-pink-500 text-2xl"></i></div><h3 class="font-semibold text-gray-800 mb-2">ChÃ¡ÂºÂ¥t lÃ†Â°Ã¡Â»Â£ng Ã„â€˜Ã¡ÂºÂ£m bÃ¡ÂºÂ£o</h3><p class="text-gray-500 text-sm">100% vÃ¡ÂºÂ£i cao cÃ¡ÂºÂ¥p, kiÃ¡Â»Æ’m Ã„â€˜Ã¡Â»â€¹nh chÃ¡ÂºÂ·t chÃ¡ÂºÂ½</p></div>
      <div class="p-6"><div class="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mx-auto mb-4"><i class="fas fa-undo text-pink-500 text-2xl"></i></div><h3 class="font-semibold text-gray-800 mb-2">Ã„ÂÃ¡Â»â€¢i trÃ¡ÂºÂ£ dÃ¡Â»â€¦ dÃƒÂ ng</h3><p class="text-gray-500 text-sm">7 ngÃƒÂ y Ã„â€˜Ã¡Â»â€¢i trÃ¡ÂºÂ£, khÃƒÂ´ng cÃ¡ÂºÂ§n lÃƒÂ½ do</p></div>
      <div class="p-6"><div class="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mx-auto mb-4"><i class="fas fa-headset text-pink-500 text-2xl"></i></div><h3 class="font-semibold text-gray-800 mb-2">HÃ¡Â»â€” trÃ¡Â»Â£ 24/7</h3><p class="text-gray-500 text-sm">TÃ†Â° vÃ¡ÂºÂ¥n nhiÃ¡Â»â€¡t tÃƒÂ¬nh, tÃ¡ÂºÂ­n tÃƒÂ¢m</p></div>
    </div>
  </div>
</section>
...
<footer class="gradient-hero text-white py-12" id="contact">
  <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8">
    <div>
      ...
      <p class="text-gray-400 text-sm leading-relaxed">ThÃ†Â°Ã†Â¡ng hiÃ¡Â»â€¡u thÃ¡Â»Âi trang ViÃ¡Â»â€¡t Nam cao cÃ¡ÂºÂ¥p, mang phong cÃƒÂ¡ch hiÃ¡Â»â€¡n Ã„â€˜Ã¡ÂºÂ¡i Ã„â€˜Ã¡ÂºÂ¿n vÃ¡Â»â€ºi mÃ¡Â»Âi ngÃ†Â°Ã¡Â»Âi.</p>
    </div>
    <div>
      <h4 class="font-semibold mb-4">LiÃƒÂªn kÃ¡ÂºÂ¿t nhanh</h4>
      <div class="flex flex-col gap-2 text-gray-400 text-sm">
        <a href="#products" class="hover:text-pink-400 transition">SÃ¡ÂºÂ£n phÃ¡ÂºÂ©m</a>
        <a href="#about" class="hover:text-pink-400 transition">VÃ¡Â»Â chÃƒÂºng tÃƒÂ´i</a>
        <a href="/admin" class="hover:text-pink-400 transition">QuÃ¡ÂºÂ£n trÃ¡Â»â€¹</a>
      </div>
    </div>
    <div>
      <h4 class="font-semibold mb-4">LiÃƒÂªn hÃ¡Â»â€¡</h4>
      <div class="flex flex-col gap-2 text-gray-400 text-sm">
        ...
        <p><i class="fas fa-map-marker-alt mr-2 text-pink-400"></i>TP. HÃ¡Â»â€œ ChÃƒÂ­ Minh, ViÃ¡Â»â€¡t Nam</p>
      </div>
    </div>
  </div>
  <div class="max-w-7xl mx-auto px-4 mt-8 pt-8 border-t border-white/10 text-center text-gray-500 text-sm">
    Ã‚Â© 2026 QH Clothes. All rights reserved.
  </div>
</footer>
...
<div id="orderOverlay" class="fixed inset-0 overlay z-50 hidden flex items-center justify-center p-4">
  <div class="popup-card bg-white rounded-3xl shadow-2xl w-full max-w-md md:max-w-[56rem] max-h-[90vh] overflow-y-auto" id="orderPopupCard">
    <div class="sticky top-0 bg-white rounded-t-3xl border-b px-6 py-4 flex items-center justify-between">
      <h3 class="font-display text-xl font-bold text-gray-900">Ã„ÂÃ¡ÂºÂ·t hÃƒÂ ng nhanh</h3>
      ...
      <div class="space-y-4">
        ...
        <div id="fieldName">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-user text-pink-400 mr-1"></i>HÃ¡Â»Â vÃƒÂ  tÃƒÂªn *
          </label>
          <input type="text" id="orderName" placeholder="NhÃ¡ÂºÂ­p hÃ¡Â»Â vÃƒÂ  tÃƒÂªn"
        ...
        <div id="fieldPhone">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-phone text-pink-400 mr-1"></i>SÃ¡Â»â€˜ Ã„â€˜iÃ¡Â»â€¡n thoÃ¡ÂºÂ¡i *
          </label>
        ...
        <div id="fieldAddress">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-map-marker-alt text-pink-400 mr-1"></i>Ã„ÂÃ¡Â»â€¹a chÃ¡Â»â€° giao hÃƒÂ ng *
          </label>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2.5">
            <div id="orderProvinceDropdown" class="relative">
              <button type="button" id="orderProvinceTrigger" onclick="toggleAddressDropdown('order','province')"
                ...
                <span id="orderProvinceLabel" class="text-gray-500">ChÃ¡Â»Ân tÃ¡Â»â€°nh/thÃƒÂ nh</span>
              ...
              <div id="orderProvinceMenu" class="hidden absolute z-[90] mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                <div class="p-2 border-b bg-gray-50">
                  <input type="text" id="orderProvinceSearch" placeholder="TÃƒÂ¬m tÃ¡Â»â€°nh/thÃƒÂ nh..."
              ...
              <select id="orderProvince" onchange="onAddressProvinceChange('order')" class="hidden">
                <option value="">ChÃ¡Â»Ân tÃ¡Â»â€°nh/thÃƒÂ nh</option>
              </select>
            </div>
            <div id="orderCommuneDropdown" class="relative">
              <button type="button" id="orderCommuneTrigger" onclick="toggleAddressDropdown('order','commune')"
                class="w-full border rounded-xl px-3.5 py-2.5 text-sm bg-white text-left flex items-center justify-between focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
                <span id="orderCommuneLabel" class="text-gray-500">ChÃ¡Â»Ân phÃ†Â°Ã¡Â»Âng/xÃƒÂ£</span>
                <i class="fas fa-chevron-down text-gray-400 text-xs"></i>
              </button>
              <div id="orderCommuneMenu" class="hidden absolute z-[90] mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                <div class="p-2 border-b bg-gray-50">
                  <input type="text" id="orderCommuneSearch" placeholder="TÃƒÂ¬m phÃ†Â°Ã¡Â»Âng/xÃƒÂ£..."
              ...
              <select id="orderCommune" onchange="onAddressCommuneChange('order')" class="hidden">
                <option value="">ChÃ¡Â»Ân phÃ†Â°Ã¡Â»Âng/xÃƒÂ£</option>
              </select>
            </div>
          </div>
          <input type="text" id="orderAddressDetail"
            placeholder="SÃ¡Â»â€˜ nhÃƒÂ , tÃƒÂªn Ã„â€˜Ã†Â°Ã¡Â»Âng..."
          ...
          <input type="text" id="orderAddress"
            readonly
            placeholder="Ã„ÂÃ¡Â»â€¹a chÃ¡Â»â€° Ã„â€˜Ã¡ÂºÂ§y Ã„â€˜Ã¡Â»Â§ sÃ¡ÂºÂ½ tÃ¡Â»Â± Ã„â€˜Ã¡Â»â„¢ng ghÃƒÂ©p tÃ¡ÂºÂ¡i Ã„â€˜ÃƒÂ¢y"
        ...
        <div id="fieldColor">
          <label class="block text-sm font-semibold text-gray-700 mb-2 field-title">
            <i class="fas fa-palette text-pink-400 mr-1"></i>MÃƒÂ u sÃ¡ÂºÂ¯c *
          </label>
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-2">
            <i class="fas fa-sort-numeric-up text-pink-400 mr-1"></i>SÃ¡Â»â€˜ lÃ†Â°Ã¡Â»Â£ng
          </label>
          <div class="flex items-center gap-3">
            <button onclick="changeQty(-1)" class="w-9 h-9 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-pink-400 hover:text-pink-500 transition font-bold">Ã¢Ë†â€™</button>
        ...
        <div id="fieldVoucher">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-tag text-pink-400 mr-1"></i>MÃƒÂ£ giÃ¡ÂºÂ£m giÃƒÂ¡ (tuÃ¡Â»Â³ chÃ¡Â»Ân)
          </label>
          <div class="flex gap-2">
            <input type="text" id="orderVoucher" placeholder="NhÃ¡ÂºÂ­p mÃƒÂ£ voucher..."
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-1.5">
            <i class="fas fa-sticky-note text-pink-400 mr-1"></i>Ghi chÃƒÂº (tuÃ¡Â»Â³ chÃ¡Â»Ân)
          </label>
          <input type="text" id="orderNote" placeholder="Ghi chÃƒÂº cho Ã„â€˜Ã†Â¡n hÃƒÂ ng..."
            class="w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
        </div>

        <div id="fieldPaymentMethod">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-credit-card text-pink-400 mr-1"></i>ChÃ¡Â»Ân phÃ†Â°Ã†Â¡ng thÃ¡Â»Â©c thanh toÃƒÂ¡n *
          </label>
          <p class="text-xs text-red-500 mb-2">TrÃ†Â°Ã¡Â»Âng nÃƒÂ y lÃƒÂ  bÃ¡ÂºÂ¯t buÃ¡Â»â„¢c</p>
          <div class="space-y-2">
            <button type="button" class="payment-method-btn w-full flex items-center gap-3 border rounded-xl px-3 py-2.5 text-left hover:border-pink-400 transition"
              ...
              <span>
                ...
                <span class="block text-xs text-gray-500">Thanh toÃƒÂ¡n khi giao</span>
              </span>
            </button>
            ...
            <div class="w-full flex items-center gap-2 border rounded-xl px-3 py-2.5 hover:border-pink-400 transition">
              ...
              <button type="button" class="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1"
                ...
                LiÃƒÂªn kÃ¡ÂºÂ¿t <i class="fas fa-chevron-right text-xs"></i>
              </button>
            </div>
            ...
            <button type="button" class="payment-method-btn w-full flex items-center gap-3 border rounded-xl px-3 py-2.5 text-left hover:border-pink-400 transition"
              ...
              <span class="block text-sm font-semibold text-gray-800">VÃƒÂ­ Ã„â€˜iÃ¡Â»â€¡n tÃ¡Â»Â­ MoMo</span>
            </button>
            ...
            <button type="button" class="payment-method-btn w-full flex items-center gap-3 border rounded-xl px-3 py-2.5 text-left hover:border-pink-400 transition"
              ...
              <span class="block text-sm font-semibold text-gray-800">ChuyÃ¡Â»Æ’n khoÃ¡ÂºÂ£n ngÃƒÂ¢n hÃƒÂ ng</span>
            </button>
          </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-pink-50 to-red-50 rounded-2xl p-4 space-y-1.5">
          <div id="subtotalRow" class="flex justify-between items-center hidden">
            <span class="text-sm text-gray-500">TÃ¡ÂºÂ¡m tÃƒÂ­nh:</span>
            <span id="orderSubtotal" class="text-sm font-semibold text-gray-700">0Ã„â€˜</span>
          </div>
          <div id="discountRow" class="flex justify-between items-center hidden">
            <span class="text-sm text-green-600 font-medium"><i class="fas fa-tag mr-1"></i>GiÃ¡ÂºÂ£m giÃƒÂ¡:</span>
            <span id="orderDiscount" class="text-sm font-bold text-green-600">-0Ã„â€˜</span>
          </div>
          <div class="flex justify-between items-center">
            <span class="font-semibold text-gray-700">TÃ¡Â»â€¢ng cÃ¡Â»â„¢ng:</span>
            <span id="orderTotal" class="text-2xl font-bold text-pink-600">0Ã„â€˜</span>
          </div>
        </div>
        ...
        <div class="flex gap-2">
          <button onclick="addCurrentToCart()" id="addToCartBtn"
            ...
            <i class="fas fa-shopping-bag"></i><span class="hidden sm:inline">GiÃ¡Â»Â hÃƒÂ ng</span>
          </button>
          <button onclick="submitOrder()" id="submitOrderBtn"
            class="btn-primary flex-1 text-white py-3.5 rounded-xl font-bold text-base">
            <i class="fas fa-bolt mr-2"></i>Ã„ÂÃ¡ÂºÂ·t ngay
          </button>
        </div>
      </div>
    </div>
  ...
  <div class="popup-card bg-white rounded-3xl shadow-2xl w-full max-w-md max-h-[92vh] overflow-y-auto">
    <div class="sticky top-0 bg-white rounded-t-3xl border-b px-6 py-4 flex items-center justify-between">
      <h3 class="font-display text-xl font-bold text-gray-900">
        <i class="fas fa-qrcode text-pink-500 mr-2"></i>QuÃƒÂ©t mÃƒÂ£ QR Ã„â€˜Ã¡Â»Æ’ thanh toÃƒÂ¡n
      </h3>
    ...
    <div class="px-6 py-5">
      <div class="border rounded-2xl p-4 bg-gray-50">
        <div class="flex justify-center mb-3">
          <img id="orderBankQrImg" src="" alt="VietQR thanh toÃƒÂ¡n Ã„â€˜Ã†Â¡n hÃƒÂ ng" class="w-56 h-56 object-contain rounded-xl border bg-white">
        </div>
        <div class="space-y-2 text-sm">
          <div class="flex justify-between items-center bg-white rounded-lg px-3 py-2 border">
            <span class="text-gray-500">NgÃƒÂ¢n hÃƒÂ ng</span>
            <span class="font-bold text-gray-800">MB Bank</span>
          </div>
          <div class="flex justify-between items-center bg-white rounded-lg px-3 py-2 border">
            <span class="text-gray-500">SÃ¡Â»â€˜ TK</span>
          ...
          <div class="flex justify-between items-center bg-white rounded-lg px-3 py-2 border">
            <span class="text-gray-500">ChÃ¡Â»Â§ TK</span>
          ...
          <div class="bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
            <p class="text-amber-700 text-xs font-semibold mb-1">NÃ¡Â»â„¢i dung CK (BÃ¡ÂºÂ®T BUÃ¡Â»ËœC)</p>
          ...
          <div class="flex justify-between items-center bg-white rounded-lg px-3 py-2 border">
            <span class="text-gray-500">SÃ¡Â»â€˜ tiÃ¡Â»Ân</span>
            <span class="font-bold text-pink-600" id="orderBankAmountDisplay"></span>
          </div>
          <div class="flex justify-between items-center bg-white rounded-lg px-3 py-2 border">
            <span class="text-gray-500">MÃƒÂ£ Ã„â€˜Ã†Â¡n</span>
      ...
      <div class="mt-4 bg-blue-50 border border-blue-200 rounded-xl px-3 py-2 text-xs text-blue-700">
        Sau khi chuyÃ¡Â»Æ’n khoÃ¡ÂºÂ£n, Ã„â€˜Ã†Â¡n hÃƒÂ ng sÃ¡ÂºÂ½ Ã„â€˜Ã†Â°Ã¡Â»Â£c xÃƒÂ¡c nhÃ¡ÂºÂ­n khi shop Ã„â€˜Ã¡Â»â€˜i soÃƒÂ¡t giao dÃ¡Â»â€¹ch.
      </div>
    </div>
  </div>
</div>
...
<div id="orderPaidNoticeOverlay" class="fixed inset-0 z-[80] hidden items-center justify-center bg-black/30 p-4">
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-xs p-5 text-center">
    ...
    <p class="text-green-600 font-bold text-lg">Ã„ÂÃƒÂ£ thanh toÃƒÂ¡n thÃƒÂ nh cÃƒÂ´ng</p>
    <p class="text-sm text-gray-600 mt-1">Ã„ÂÃ†Â¡n hÃƒÂ ng Ã„â€˜ÃƒÂ£ Ã„â€˜Ã†Â°Ã¡Â»Â£c ghi nhÃ¡ÂºÂ­n.</p>
...
<div id="detailOverlay" class="fixed inset-0 overlay hidden flex items-center justify-center p-4" style="z-index:1001;">
  <div class="popup-card bg-white rounded-3xl shadow-2xl w-full max-w-md md:max-w-[56rem] max-h-[90vh] overflow-y-auto">
    <div class="sticky top-0 bg-white rounded-t-3xl border-b px-6 py-4 flex items-center justify-between">
      <h3 class="font-display text-xl font-bold text-gray-900">Chi tiÃ¡ÂºÂ¿t sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m</h3>
  ...
  <div id="cartModal" class="cart-modal absolute right-0 top-0 bottom-0 w-full max-w-lg bg-white flex flex-col shadow-2xl">
    ...
    <div id="cartHeader" class="flex items-center justify-between px-5 py-4 border-b bg-gradient-to-r from-gray-900 to-gray-800 text-white flex-shrink-0">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 id="cartTitle" class="font-display text-lg font-bold">GiÃ¡Â»Â hÃƒÂ ng</h2>
          <p id="cartSubtitle" class="text-xs text-gray-300">ChÃ†Â°a cÃƒÂ³ sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m</p>
        </div>
      </div>
    ...
    <div id="cartStep1" class="flex flex-col flex-1 overflow-hidden">
      ...
      <div id="cartCheckAllBar" class="hidden flex items-center gap-3 px-5 py-3 bg-gray-50 border-b flex-shrink-0">
        <label class="flex items-center gap-2 cursor-pointer select-none">
          ...
          <span class="text-sm font-medium text-gray-700">ChÃ¡Â»Ân tÃ¡ÂºÂ¥t cÃ¡ÂºÂ£</span>
        </label>
        ...
        <button onclick="removeChecked()" id="deleteCheckedBtn" class="hidden text-xs text-red-500 hover:text-red-600 font-medium transition">
          <i class="fas fa-trash mr-1"></i>XoÃƒÂ¡ Ã„â€˜ÃƒÂ£ chÃ¡Â»Ân
        </button>
      </div>
      ...
      <div id="cartFooter" class="hidden flex-shrink-0 border-t bg-white px-5 py-4">
        <div class="flex items-center justify-between mb-3">
          <span class="text-gray-600 font-medium">TÃ¡Â»â€¢ng cÃ¡Â»â„¢ng (<span id="cartSelectedItems">0</span> sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m):</span>
          <span id="cartTotalPrice" class="text-xl font-bold text-pink-600">0Ã„â€˜</span>
        </div>
        <button onclick="proceedToCheckout()" id="checkoutBtn"
          ...
          <i class="fas fa-credit-card mr-2"></i>XÃƒÂ¡c nhÃ¡ÂºÂ­n & Ã„ÂÃ¡ÂºÂ·t hÃƒÂ ng
        </button>
      </div>
    </div>
    ...
    <div id="cartStep2" class="hidden flex-col flex-1 overflow-hidden checkout-slide">
      ...
      <div class="flex-1 overflow-y-auto px-5 py-4">
        <h3 class="font-display text-base font-bold text-gray-800 mb-4">ThÃƒÂ´ng tin giao hÃƒÂ ng</h3>
        <div class="space-y-4">
          <!-- HÃ¡Â»Â tÃƒÂªn -->
          <div id="ckFieldName">
            <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            ...
            <input type="text" id="ckName" placeholder="NhÃ¡ÂºÂ­p hÃ¡Â»Â vÃƒÂ  tÃƒÂªn"
              class="w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2.5">
              <div id="ckProvinceDropdown" class="relative">
                <button type="button" id="ckProvinceTrigger" onclick="toggleAddressDropdown('ck','province')"
                  class="w-full border rounded-xl px-3.5 py-2.5 text-sm bg-white text-left flex items-center justify-between focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
                  <span id="ckProvinceLabel" class="text-gray-500">ChÃ¡Â»Ân tÃ¡Â»â€°nh/thÃƒÂ nh</span>
                  <i class="fas fa-chevron-down text-gray-400 text-xs"></i>
                </button>
                <div id="ckProvinceMenu" class="hidden absolute z-[90] mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                  <div class="p-2 border-b bg-gray-50">
                    <input type="text" id="ckProvinceSearch" placeholder="TÃƒÂ¬m tÃ¡Â»â€°nh/thÃƒÂ nh..."
              ...
              <div id="ckCommuneDropdown" class="relative">
                <button type="button" id="ckCommuneTrigger" onclick="toggleAddressDropdown('ck','commune')"
                  class="w-full border rounded-xl px-3.5 py-2.5 text-sm bg-white text-left flex items-center justify-between focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
                  <span id="ckCommuneLabel" class="text-gray-500">ChÃ¡Â»Ân phÃ†Â°Ã¡Â»Âng/xÃƒÂ£</span>
                  <i class="fas fa-chevron-down text-gray-400 text-xs"></i>
                </button>
                <div id="ckCommuneMenu" class="hidden absolute z-[90] mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                  <div class="p-2 border-b bg-gray-50">
                    <input type="text" id="ckCommuneSearch" placeholder="TÃƒÂ¬m phÃ†Â°Ã¡Â»Âng/xÃƒÂ£..."
          ...
          <div id="ckFieldVoucher">
            ...
            <div class="flex gap-2">
              <input type="text" id="ckVoucher" placeholder="NhÃ¡ÂºÂ­p mÃƒÂ£ voucher..."
                class="flex-1 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200 uppercase tracking-wider"
                oninput="this.value=this.value.toUpperCase()">
          ...
          <div>
            ...
            <input type="text" id="ckNote" placeholder="Ghi chÃƒÂº cho Ã„â€˜Ã†Â¡n hÃƒÂ ng..."
              class="w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
          </div>
          <!-- Total box -->
          <div class="bg-gradient-to-r from-pink-50 to-red-50 rounded-2xl p-4 space-y-1.5">
            <div id="ckSubtotalRow" class="hidden flex justify-between items-center">
              <span class="text-sm text-gray-500">TÃ¡ÂºÂ¡m tÃƒÂ­nh:</span>
              <span id="ckSubtotal" class="text-sm font-semibold text-gray-700">0Ã„â€˜</span>
            </div>
            <div id="ckDiscountRow" class="hidden flex justify-between items-center">
              <span class="text-sm text-green-600 font-medium"><i class="fas fa-tag mr-1"></i>GiÃ¡ÂºÂ£m giÃƒÂ¡:</span>
              <span id="ckDiscount" class="text-sm font-bold text-green-600">-0Ã„â€˜</span>
            </div>
            <div class="flex justify-between items-center">
              <span class="font-semibold text-gray-700">TÃ¡Â»â€¢ng cÃ¡Â»â„¢ng:</span>
              <span id="ckTotal" class="text-2xl font-bold text-pink-600">0Ã„â€˜</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex-shrink-0 border-t bg-white px-5 py-4">
        <button onclick="submitCartOrder()" id="submitCartBtn"
          ...
          <i class="fas fa-shopping-cart mr-2"></i>Ã„ÂÃ¡ÂºÂ·t hÃƒÂ ng ngay
        </button>
      </div>
    </div>
  ...
  <div id="userMenuPanel" class="user-menu-panel absolute right-0 top-0 bottom-0 w-full max-w-sm bg-white flex flex-col shadow-2xl">
    ...
    <div class="bg-gradient-to-r from-gray-900 to-gray-800 text-white px-5 py-5 flex-shrink-0">
      <div class="flex items-center justify-between mb-4">
        <h2 class="font-display text-lg font-bold">TÃƒÂ i khoÃ¡ÂºÂ£n</h2>
      ...
      <div id="userMenuGuest">
        <p class="text-gray-300 text-sm mb-3">Ã„ÂÃ„Æ’ng nhÃ¡ÂºÂ­p Ã„â€˜Ã¡Â»Æ’ lÃ†Â°u lÃ¡Â»â€¹ch sÃ¡Â»Â­ Ã„â€˜Ã†Â¡n hÃƒÂ ng</p>
        <button onclick="loginWithGoogle()" class="w-full flex items-center justify-center gap-3 bg-white text-gray-800 px-4 py-3 rounded-xl font-semibold text-sm hover:bg-gray-100 transition">
          ...
          Ã„ÂÃ„Æ’ng nhÃ¡ÂºÂ­p bÃ¡ÂºÂ±ng Google
        </button>
      </div>
      <!-- Logged in state -->
    ...
    <div class="flex-1 overflow-y-auto px-4 py-4">
      <nav class="space-y-1">
        <button onclick="showUserAccount()" class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-pink-50 hover:text-pink-600 transition text-sm font-medium text-left">
          <i class="fas fa-user-circle w-5 text-pink-400"></i>QuÃ¡ÂºÂ£n lÃƒÂ½ tÃƒÂ i khoÃ¡ÂºÂ£n
        </button>
        <button onclick="showUserOrders()" id="userOrdersBtn" class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-pink-50 hover:text-pink-600 transition text-sm font-medium text-left">
          <i class="fas fa-clipboard-list w-5 text-pink-400"></i>LÃ¡Â»â€¹ch sÃ¡Â»Â­ mua hÃƒÂ ng
        </button>
        <button onclick="showWalletInMenu()" class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-pink-50 hover:text-pink-600 transition text-sm font-medium text-left">
          <i class="fas fa-wallet w-5 text-pink-400"></i>NÃ¡ÂºÂ¡p tiÃ¡Â»Ân vÃƒÂ o vÃƒÂ­
          <span id="walletBalanceMenu" class="ml-auto text-xs bg-green-50 text-green-600 px-2 py-0.5 rounded-full font-semibold">0Ã„â€˜</span>
        </button>
      </nav>
      <!-- Content area -->
    ...
    <div id="userMenuLogoutArea" class="hidden flex-shrink-0 border-t px-5 py-4">
      <button onclick="logoutUser()" class="w-full flex items-center justify-center gap-2 border-2 border-red-200 text-red-500 py-2.5 rounded-xl font-semibold text-sm hover:bg-red-50 transition">
        <i class="fas fa-sign-out-alt"></i>Ã„ÂÃ„Æ’ng xuÃ¡ÂºÂ¥t
      </button>
    </div>
  </div>
</div>
...
// Ã¢â€â‚¬Ã¢â€â‚¬ CART STATE Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
function renderAddressDropdownList(scope, type, keyword = '') {
  ...
  const placeholder = String(selectEl.options?.[0]?.textContent || (type === 'province' ? 'ChÃ¡Â»Ân tÃ¡Â»â€°nh/thÃƒÂ nh' : 'ChÃ¡Â»Ân phÃ†Â°Ã¡Â»Âng/xÃƒÂ£'))
  ...
  if (!filtered.length) {
    optionsEl.innerHTML = '<div class="px-3 py-2 text-sm text-gray-400">KhÃƒÂ´ng tÃƒÂ¬m thÃ¡ÂºÂ¥y kÃ¡ÂºÂ¿t quÃ¡ÂºÂ£</div>'
    return
  }
...
function renderProvinceOptionsForScope(scope, keyword = '') {
  ...
  setAddressSelectOptions(provinceEl, filtered, filtered.length ? 'ChÃ¡Â»Ân tÃ¡Â»â€°nh/thÃƒÂ nh' : 'KhÃƒÂ´ng tÃƒÂ¬m thÃ¡ÂºÂ¥y tÃ¡Â»â€°nh/thÃƒÂ nh')
...
function renderCommuneOptionsForScope(scope, keyword = '') {
  ...
  const placeholder = provinceCode
    ? (filtered.length ? 'ChÃ¡Â»Ân phÃ†Â°Ã¡Â»Âng/xÃƒÂ£' : 'KhÃƒÂ´ng tÃƒÂ¬m thÃ¡ÂºÂ¥y phÃ†Â°Ã¡Â»Âng/xÃƒÂ£')
    : 'ChÃ¡Â»Ân phÃ†Â°Ã¡Â»Âng/xÃƒÂ£'
...
function resetAddressScope(scope) {
  ...
  if (communeEl) setAddressSelectOptions(communeEl, [], 'ChÃ¡Â»Ân phÃ†Â°Ã¡Â»Âng/xÃƒÂ£')
...
async function onAddressProvinceChange(scope) {
  ...
  addressDropdownSearchState[scope + ':commune'] = ''
  setAddressSelectOptions(communeEl, [], selectedCode ? 'Ã„Âang tÃ¡ÂºÂ£i phÃ†Â°Ã¡Â»Âng/xÃƒÂ£...' : 'ChÃ¡Â»Ân phÃ†Â°Ã¡Â»Âng/xÃƒÂ£')
  renderAddressDropdownList(scope, 'commune', '')
  if (!selectedCode) {
  ...
  try {
    ...
    setAddressSelectOptions(communeEl, [], 'KhÃƒÂ´ng tÃ¡ÂºÂ£i Ã„â€˜Ã†Â°Ã¡Â»Â£c phÃ†Â°Ã¡Â»Âng/xÃƒÂ£')
    showToast('KhÃƒÂ´ng tÃ¡ÂºÂ£i Ã„â€˜Ã†Â°Ã¡Â»Â£c danh sÃƒÂ¡ch phÃ†Â°Ã¡Â»Âng/xÃƒÂ£. Vui lÃƒÂ²ng thÃ¡Â»Â­ lÃ¡ÂºÂ¡i.', 'error', 4500)
  }
  syncAddressFullText(scope)
  if (scope === 'ck') clearCheckoutError(ids.fieldId)
  else clearFieldError(ids.fieldId)
...
// Ã¢â€â‚¬Ã¢â€â‚¬ INIT Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
async function loadProducts() {
  try {
    ...
    document.getElementById('productsGrid').innerHTML = '<div class="col-span-4 text-center text-gray-400 py-12"><i class="fas fa-exclamation-circle text-4xl mb-3"></i><p>KhÃƒÂ´ng thÃ¡Â»Æ’ tÃ¡ÂºÂ£i sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m</p></div>'
  }
}
  ...
  grid.innerHTML = products.map(p => {
    ...
    <div class="bg-white rounded-2xl overflow-hidden card-hover shadow-sm border border-gray-100 cursor-pointer" onclick="showDetail(\${p.id})">
      <div class="relative overflow-hidden bg-gray-100">
        ...
        \${p.is_featured ? \`<span class="absolute top-3 right-3 bg-amber-400 text-white text-xs font-bold px-2 py-1 rounded-full">Ã¢Â­Â Hot</span>\` : ''}
        <div class="absolute inset-0 bg-black/0 hover:bg-black/10 transition flex items-center justify-center opacity-0 hover:opacity-100">
          <span class="bg-white/90 text-gray-800 px-3 py-1 rounded-full text-xs font-semibold">Xem chi tiÃ¡ÂºÂ¿t</span>
        </div>
      </div>
      <div class="p-3 md:p-4">
        ...
        <div class="flex gap-2">
          ...
          <button onclick="event.stopPropagation();addToCartFromCard(event, \${p.id})" title="ThÃƒÂªm vÃƒÂ o giÃ¡Â»Â hÃƒÂ ng"
...
// Ã¢â€â‚¬Ã¢â€â‚¬ FILTER & SEARCH Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬ PRODUCT DETAIL Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
async function showDetail(id) {
  try {
    ...
    <div class="grid md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        \${p.material ? \`<p class="text-sm text-gray-500 mb-4"><strong>ChÃ¡ÂºÂ¥t liÃ¡Â»â€¡u:</strong> \${p.material}</p>\` : ''}
        \${detailColorOptions.length ? \`
        <div class="mb-4">
          <p class="text-sm font-semibold mb-2">MÃƒÂ u sÃ¡ÂºÂ¯c: <span class="text-pink-500" id="detailColorLabel"></span></p>
            ...
            \${detailColorOptions.map((item, idx) => \`<button type="button"
              ...
              <div class="relative aspect-square bg-gray-100 overflow-hidden">
                \${item.image
                  ...
                  : \`<div class="w-full h-full flex items-center justify-center text-gray-300 text-xs">KhÃƒÂ´ng cÃƒÂ³ Ã¡ÂºÂ£nh</div>\`}
              </div>
  ...
  } catch(e) { showToast('KhÃƒÂ´ng thÃ¡Â»Æ’ tÃ¡ÂºÂ£i chi tiÃ¡ÂºÂ¿t sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m', 'error') }
}
...
// Ã¢â€â‚¬Ã¢â€â‚¬ ORDER POPUP Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
async function openOrder(id) {
  try {
    ...
    \`).join('') : '<p class="text-gray-400 text-sm">KhÃƒÂ´ng cÃƒÂ³ lÃ¡Â»Â±a chÃ¡Â»Ân mÃƒÂ u</p>'
    ...
    \`).join('') : '<p class="text-gray-400 text-sm">KhÃƒÂ´ng cÃƒÂ³ size</p>'
  ...
  } catch(e) { showToast('LÃ¡Â»â€”i khi tÃ¡ÂºÂ£i sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m', 'error') }
}
...
// Add to cart from product card Ã¢â‚¬â€œ always add directly, pick first color/size as default
async function addToCartFromCard(evt, id) {
  try {
    ...
    showToast('Ã„ÂÃƒÂ£ thÃƒÂªm "' + p.name + '" vÃƒÂ o giÃ¡Â»Â hÃƒÂ ng!', 'success', 2500)
  } catch(e) { showToast('LÃ¡Â»â€”i khi thÃƒÂªm vÃƒÂ o giÃ¡Â»Â', 'error') }
}

// Ã¢â€â‚¬Ã¢â€â‚¬ VOUCHER Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
async function applyVoucher() {
  ...
  if (!code) {
    ...
    statusEl.innerHTML = '<i class="fas fa-times-circle mr-1"></i>Vui lÃƒÂ²ng nhÃ¡ÂºÂ­p mÃƒÂ£ voucher'
  ...
  try {
    ...
    statusEl.innerHTML = \`<i class="fas fa-check-circle text-green-500"></i>ÃƒÂp dÃ¡Â»Â¥ng thÃƒÂ nh cÃƒÂ´ng! GiÃ¡ÂºÂ£m <strong>\${fmtPrice(appliedVoucher.discount_amount)}</strong>\`
    statusEl.classList.remove('hidden')
    updateOrderTotal()
    ...
    const msg = errCode === 'VOUCHER_LIMIT' ? 'Voucher Ã„â€˜ÃƒÂ£ hÃ¡ÂºÂ¿t lÃ†Â°Ã¡Â»Â£t sÃ¡Â»Â­ dÃ¡Â»Â¥ng'
              : errCode === 'INVALID_VOUCHER' ? 'MÃƒÂ£ khÃƒÂ´ng hÃ¡Â»Â£p lÃ¡Â»â€¡ hoÃ¡ÂºÂ·c Ã„â€˜ÃƒÂ£ hÃ¡ÂºÂ¿t hÃ¡ÂºÂ¡n'
              : 'KhÃƒÂ´ng thÃ¡Â»Æ’ ÃƒÂ¡p dÃ¡Â»Â¥ng mÃƒÂ£ nÃƒÂ y'
    ...
    btn.disabled = false
    btn.innerHTML = appliedVoucher ? '<i class="fas fa-check mr-1"></i>Ã„ÂÃƒÂ£ ÃƒÂ¡p dÃ¡Â»Â¥ng' : 'ÃƒÂp dÃ¡Â»Â¥ng'
...
// Ã¢â€â‚¬Ã¢â€â‚¬ VALIDATION SHAKE + SCROLL Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬ SUBMIT ORDER Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
async function submitOrder() {
  ...
  btn.disabled = true
  btn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Ã„Âang xÃ¡Â»Â­ lÃƒÂ½...'
  let payTabRef = null
  ...
  try {
    ...
    if (selectedPaymentMethod === 'BANK_TRANSFER') {
      ...
      try {
        ...
        showToast('PayOS tÃ¡ÂºÂ¡m lÃ¡Â»â€”i, Ã„â€˜ang chuyÃ¡Â»Æ’n sang QR dÃ¡Â»Â± phÃƒÂ²ng.', 'error', 4500)
      }
      if (payosData?.alreadyPaid) {
        onOrderMarkedPaid(orderCode)
        showToast('Ã„ÂÃ†Â¡n ' + orderCode + ' Ã„â€˜ÃƒÂ£ Ã„â€˜Ã†Â°Ã¡Â»Â£c thanh toÃƒÂ¡n trÃ†Â°Ã¡Â»â€ºc Ã„â€˜ÃƒÂ³.', 'success', 4500)
        return
      }
      ...
      if (checkoutUrl) {
        ...
        if (payTab) {
          ...
          showToast(\`Ã„ÂÃ†Â¡n \${orderCode}: Ã„â€˜ÃƒÂ£ mÃ¡Â»Å¸ tab PayOS, vui lÃƒÂ²ng hoÃƒÂ n tÃ¡ÂºÂ¥t thanh toÃƒÂ¡n.\`, 'success', 5000)
        } else {
          showToast('TrÃƒÂ¬nh duyÃ¡Â»â€¡t Ã„â€˜ang chÃ¡ÂºÂ·n popup, hiÃ¡Â»Æ’n thÃ¡Â»â€¹ QR dÃ¡Â»Â± phÃƒÂ²ng Ã„â€˜Ã¡Â»Æ’ bÃ¡ÂºÂ¡n thanh toÃƒÂ¡n thÃ¡Â»Â§ cÃƒÂ´ng.', 'error', 5000)
        ...
        showToast(\`Ã„ÂÃ†Â¡n hÃƒÂ ng \${orderCode} Ã„â€˜ÃƒÂ£ tÃ¡ÂºÂ¡o. Vui lÃƒÂ²ng chuyÃ¡Â»Æ’n khoÃ¡ÂºÂ£n Ã„â€˜Ã¡Â»Æ’ hoÃƒÂ n tÃ¡ÂºÂ¥t.\`, 'success', 5000)
      }
    } else if (selectedPaymentMethod === 'ZALOPAY') {
      let zaloData = null
      try {
      ...
      if (!checkoutUrl) {
        try { if (payTabRef && !payTabRef.closed) payTabRef.close() } catch (_) { }
        showToast('KhÃƒÂ´ng tÃ¡ÂºÂ¡o Ã„â€˜Ã†Â°Ã¡Â»Â£c liÃƒÂªn kÃ¡ÂºÂ¿t thanh toÃƒÂ¡n ZaloPay.', 'error', 4500)
        return
      }
      ...
      if (payTab) {
        ...
        startOrderPaymentPolling(orderCode)
        showToast(\`Ã„ÂÃ†Â¡n \${orderCode}: Ã„â€˜ÃƒÂ£ mÃ¡Â»Å¸ tab ZaloPay, vui lÃƒÂ²ng quÃƒÂ©t QR Ã„â€˜Ã¡Â»Æ’ thanh toÃƒÂ¡n.\`, 'success', 5000)
      } else {
        // Fallback: popup bÃ¡Â»â€¹ chÃ¡ÂºÂ·n, Ã„â€˜iÃ¡Â»Âu hÃ†Â°Ã¡Â»â€ºng luÃƒÂ´n tÃ¡ÂºÂ¡i tab hiÃ¡Â»â€¡n tÃ¡ÂºÂ¡i
        startOrderPaymentPolling(orderCode)
        window.location.href = checkoutUrl
      }
    } else {
      showToast(\`Ã°Å¸Å½â€° Ã„ÂÃ¡ÂºÂ·t hÃƒÂ ng thÃƒÂ nh cÃƒÂ´ng! MÃƒÂ£ Ã„â€˜Ã†Â¡n: \${orderCode}\`, 'success', 5000)
    }
  } catch(e) {
    try { if (payTabRef && !payTabRef.closed) payTabRef.close() } catch (_) { }
    const errCode = e.response?.data?.error
    if (errCode === 'INVALID_VOUCHER' || errCode === 'VOUCHER_LIMIT') {
      showToast('Voucher khÃƒÂ´ng cÃƒÂ²n hiÃ¡Â»â€¡u lÃ¡Â»Â±c, vui lÃƒÂ²ng thÃ¡Â»Â­ lÃ¡ÂºÂ¡i', 'error')
      appliedVoucher = null
      updateOrderTotal()
      document.getElementById('voucherBtn').innerHTML = 'ÃƒÂp dÃ¡Â»Â¥ng'
      ...
      showToast('Ã„ÂÃ¡ÂºÂ·t hÃƒÂ ng thÃ¡ÂºÂ¥t bÃ¡ÂºÂ¡i, thÃ¡Â»Â­ lÃ¡ÂºÂ¡i sau', 'error')
    }
  } finally {
    btn.disabled = false
    btn.innerHTML = '<i class="fas fa-shopping-cart mr-2"></i>Ã„ÂÃ¡ÂºÂ·t hÃƒÂ ng ngay'
  }
}
...
// Ã¢â€â‚¬Ã¢â€â‚¬ UTILS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
function formatPaymentMethod(v) {
  ...
  if (key === 'MOMO') return 'VÃƒÂ­ Ã„â€˜iÃ¡Â»â€¡n tÃ¡Â»Â­ MoMo'
  if (key === 'BANK_TRANSFER') return 'ChuyÃ¡Â»Æ’n khoÃ¡ÂºÂ£n ngÃƒÂ¢n hÃƒÂ ng'
  return 'COD - Thanh toÃƒÂ¡n khi giao'
}
function paymentStatusLabel(v) {
  return String(v || '').toLowerCase() === 'paid' ? 'Ã„ÂÃƒÂ£ thanh toÃƒÂ¡n' : 'ChÃ†Â°a thanh toÃƒÂ¡n'
}
...
// Ã¢â€â‚¬Ã¢â€â‚¬ CART MODAL Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
function openCart() {
  cartStep = 1
  ...
  document.getElementById('cartTitle').textContent = 'GiÃ¡Â»Â hÃƒÂ ng'
  document.body.style.overflow = 'hidden'
}
function closeCart() {
...
// Ã¢â€â‚¬Ã¢â€â‚¬ SWIPE TO DELETE Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬ CHECKOUT from CART Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
async function proceedToCheckout() {
  const checked = cart.filter(i=>i.checked)
  if (checked.length === 0) { showToast('Vui lÃƒÂ²ng chÃ¡Â»Ân ÃƒÂ­t nhÃ¡ÂºÂ¥t 1 sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m','error'); return }
  try {
    await ensureAddressKitReady()
  } catch (_) {
    showToast('KhÃƒÂ´ng tÃ¡ÂºÂ£i Ã„â€˜Ã†Â°Ã¡Â»Â£c danh mÃ¡Â»Â¥c Ã„â€˜Ã¡Â»â€¹a chÃ¡Â»â€°, vui lÃƒÂ²ng thÃ¡Â»Â­ lÃ¡ÂºÂ¡i.', 'error', 4500)
    return
  }
  // Build summary
  ...
  document.getElementById('ckVoucherBtn').textContent = 'ÃƒÂp dÃ¡Â»Â¥ng'
  ...
  document.getElementById('cartTitle').textContent = 'XÃƒÂ¡c nhÃ¡ÂºÂ­n Ã„â€˜Ã†Â¡n hÃƒÂ ng'
...
async function applyCkVoucher() {
  ...
  try {
    ...
    ckAppliedVoucher = null
    const errCode = err.response?.data?.error
    const msg = errCode==='VOUCHER_LIMIT'?'Voucher Ã„â€˜ÃƒÂ£ hÃ¡ÂºÂ¿t lÃ†Â°Ã¡Â»Â£t':errCode==='INVALID_VOUCHER'?'MÃƒÂ£ khÃƒÂ´ng hÃ¡Â»Â£p lÃ¡Â»â€¡ hoÃ¡ÂºÂ·c hÃ¡ÂºÂ¿t hÃ¡ÂºÂ¡n':'KhÃƒÂ´ng thÃ¡Â»Æ’ ÃƒÂ¡p dÃ¡Â»Â¥ng'
    statusEl.className='mt-2 voucher-error rounded-xl px-3 py-2 text-sm text-red-600 font-medium flex items-center gap-1'
    statusEl.innerHTML='<i class="fas fa-times-circle mr-1"></i>' + msg
    statusEl.classList.remove('hidden')
    ...
    btn.disabled=false
    btn.innerHTML = ckAppliedVoucher ? '<i class="fas fa-check mr-1"></i>Ã„ÂÃƒÂ£ ÃƒÂ¡p dÃ¡Â»Â¥ng' : 'ÃƒÂp dÃ¡Â»Â¥ng'
...
async function submitCartOrder() {
  ...
  try {
    ...
    const errCode = e.response?.data?.error
    if (errCode==='INVALID_VOUCHER'||errCode==='VOUCHER_LIMIT') {
      showToast('Voucher khÃƒÂ´ng cÃƒÂ²n hiÃ¡Â»â€¡u lÃ¡Â»Â±c','error')
      ckAppliedVoucher=null; updateCkTotal()
      document.getElementById('ckVoucherBtn').innerHTML='ÃƒÂp dÃ¡Â»Â¥ng'
      document.getElementById('ckVoucherBtn').className='px-4 py-2.5 bg-gray-800 hover:bg-gray-700 text-white rounded-xl text-sm font-semibold transition whitespace-nowrap'
    } else { showToast('Ã„ÂÃ¡ÂºÂ·t hÃƒÂ ng thÃ¡ÂºÂ¥t bÃ¡ÂºÂ¡i, thÃ¡Â»Â­ lÃ¡ÂºÂ¡i sau','error') }
  } finally {
    btn.disabled=false
    btn.innerHTML='<i class="fas fa-shopping-cart mr-2"></i>Ã„ÂÃ¡ÂºÂ·t hÃƒÂ ng ngay'
  }
...
// Ã¢â€â‚¬Ã¢â€â‚¬ DYNAMIC HERO BANNERS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
let heroBannersData = []
...
function mapTrendingProductsToHeroCards(products) {
  ...
  return products.map((p) => {
    ...
    return {
      ...
      subtitle: categoryLabel + ' Ã‚Â· Dang thinh hanh',
      title: p.name || '',
...
function renderCollapsedBanners(banners) {
  ...
  if (!banners.length) {
    container.innerHTML = \`<div class="relative w-full h-full rounded-3xl border border-white/20 bg-white/5 flex items-center justify-center text-center px-6">
      <div>
        ...
        <p class="text-white/80 text-sm font-medium">ChÃ†Â°a cÃƒÂ³ sÃ¡ÂºÂ£n phÃ¡ÂºÂ©m thÃ¡Â»â€¹nh hÃƒÂ nh</p>
      </div>
    </div>\`
    return
  }
  ...
  <div class="absolute flex items-center gap-1.5 bg-white/20 backdrop-blur-sm rounded-full px-3 py-1.5 text-white text-xs font-medium cursor-pointer hover:bg-white/30 transition whitespace-nowrap" style="bottom:-28px;left:50%;transform:translateX(-50%);z-index:5" onclick="expandBanners()">
    <i class="fas fa-expand-alt mr-1 text-pink-300"></i>CÃƒÂ¡c mÃ¡ÂºÂ«u thÃ¡Â»â€¹nh hÃƒÂ nh
  </div>\`
...
function renderExpandedBanners(banners) {
  ...
  if (!inner) return
  if (title) title.textContent = \`Ã°Å¸â€Â¥ Ã„Âang thÃ¡Â»â€¹nh hÃƒÂ nh (\${banners.length} mÃ¡ÂºÂ«u)\`
...
ensureAddressKitReady().catch(() => {
  showToast('KhÃƒÂ´ng tÃ¡ÂºÂ£i Ã„â€˜Ã†Â°Ã¡Â»Â£c danh mÃ¡Â»Â¥c tÃ¡Â»â€°nh/phÃ†Â°Ã¡Â»Âng. BÃ¡ÂºÂ¡n cÃƒÂ³ thÃ¡Â»Æ’ thÃ¡Â»Â­ lÃ¡ÂºÂ¡i sau.', 'error', 4500)
})
...
// Ã¢â€â‚¬Ã¢â€â‚¬ USER AUTH & MENU Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
function fmtBalance(v) { return new Intl.NumberFormat('vi-VN').format(v||0) + 'Ã„â€˜' }
...
async function logoutUser() {
  ...
  updateUserUI()
  closeUserMenu()
  showToast('Ã„ÂÃƒÂ£ Ã„â€˜Ã„Æ’ng xuÃ¡ÂºÂ¥t thÃƒÂ nh cÃƒÂ´ng', 'success')
}

function showUserAccount() {
  const content = document.getElementById('userMenuContent')
  if (!currentUser) {
    content.innerHTML = '<div class="text-center py-8 text-gray-400"><i class="fas fa-lock text-3xl mb-3"></i><p>Vui lÃƒÂ²ng Ã„â€˜Ã„Æ’ng nhÃ¡ÂºÂ­p Ã„â€˜Ã¡Â»Æ’ xem thÃƒÂ´ng tin</p></div>'
    return
  }
  content.innerHTML = '<div class="bg-white rounded-2xl border p-4 space-y-3">'
    + '<h3 class="font-semibold text-gray-800 mb-3"><i class="fas fa-user-circle text-pink-400 mr-2"></i>ThÃƒÂ´ng tin tÃƒÂ i khoÃ¡ÂºÂ£n</h3>'
...
async function showUserOrders() {
  const content = document.getElementById('userMenuContent')
  if (!currentUser) {
    content.innerHTML = '<div class="text-center py-8 text-gray-400"><i class="fas fa-lock text-3xl mb-3"></i><p>Vui lÃƒÂ²ng Ã„â€˜Ã„Æ’ng nhÃ¡ÂºÂ­p Ã„â€˜Ã¡Â»Æ’ xem lÃ¡Â»â€¹ch sÃ¡Â»Â­</p></div>'
    return
  }
  ...
  try {
    ...
    if (!orders.length) {
      content.innerHTML = '<div class="text-center py-8 text-gray-400"><i class="fas fa-shopping-bag text-4xl mb-3"></i><p>ChÃ†Â°a cÃƒÂ³ Ã„â€˜Ã†Â¡n hÃƒÂ ng nÃƒÂ o</p></div>'
      return
    }
    content.innerHTML = '<h3 class="font-semibold text-gray-800 mb-3"><i class="fas fa-clipboard-list text-pink-400 mr-2"></i>LÃ¡Â»â€¹ch sÃ¡Â»Â­ mua hÃƒÂ ng</h3>'
      + '<div class="space-y-2">' + orders.map(function(o) {
        ...
        const paymentBadgeText = paymentPaid ? 'Ã„ÂÃƒÂ£ thanh toÃƒÂ¡n' : 'ChÃ†Â°a thanh toÃƒÂ¡n'
        ...
        const colorText = String(o.color || '').trim() || 'ChÆ°a chá»n'
        ...
        const resumeActionHtml = canResume
          ? '<button class="mt-2 w-full rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold px-3 py-2 transition" onclick="resumeOrderPayment(' + o.id + ',\\'' + safeOrderCode + '\\',\\'' + methodArg + '\\')"><i class="fas fa-qrcode mr-1"></i>Thanh toÃƒÂ¡n</button>'
          : ''
        ...
        return '<div class="order-history-item border rounded-xl p-3">'
          ...
          + '<p class="text-xs text-gray-500 mt-1">MÃ u: ' + escapeHtml(colorText) + ' | Size: ' + escapeHtml(sizeText) + '</p>'
  ...
  } catch { content.innerHTML = '<div class="text-center py-8 text-red-400">LÃ¡Â»â€”i tÃ¡ÂºÂ£i dÃ¡Â»Â¯ liÃ¡Â»â€¡u</div>' }
}
...
async function resumeOrderPayment(orderId, orderCode, paymentMethod) {
  ...
  try {
    ...
    if (paymentData.alreadyPaid) {
      ...
      showUserOrders()
      showToast('Ã„ÂÃ†Â¡n nÃƒÂ y Ã„â€˜ÃƒÂ£ thanh toÃƒÂ¡n thÃƒÂ nh cÃƒÂ´ng', 'success', 3500)
      return
    }
    ...
    if (!checkoutUrl) {
      try { if (payTab && !payTab.closed) payTab.close() } catch (_) { }
      showToast('KhÃƒÂ´ng tÃ¡ÂºÂ¡o Ã„â€˜Ã†Â°Ã¡Â»Â£c link thanh toÃƒÂ¡n ' + providerLabel, 'error', 3500)
      return
    }
    if (!openCheckoutUrl(checkoutUrl)) {
      showToast('TrÃƒÂ¬nh duyÃ¡Â»â€¡t Ã„â€˜ang chÃ¡ÂºÂ·n popup, vui lÃƒÂ²ng cho phÃƒÂ©p mÃ¡Â»Å¸ tab mÃ¡Â»â€ºi', 'warning', 3800)
      return
    }
    startOrderPaymentPolling(orderCode)
    showToast('Ã„Âang mÃ¡Â»Å¸ lÃ¡ÂºÂ¡i trang ' + providerLabel + ' Ã„â€˜Ã¡Â»Æ’ bÃ¡ÂºÂ¡n thanh toÃƒÂ¡n tiÃ¡ÂºÂ¿p', 'success', 3500)
  } catch (err) {
    const errCode = err.response?.data?.error
    ...
    if (errCode === 'PAYOS_CONFIG_MISSING') {
      showToast('PayOS chÃ†Â°a cÃ¡ÂºÂ¥u hÃƒÂ¬nh Ã„â€˜Ã¡ÂºÂ§y Ã„â€˜Ã¡Â»Â§, vui lÃƒÂ²ng liÃƒÂªn hÃ¡Â»â€¡ shop', 'error', 5500)
      return
    }
    if (errCode === 'PAYMENT_METHOD_NOT_BANK_TRANSFER') {
      showToast('Ã„ÂÃ†Â¡n nÃƒÂ y khÃƒÂ´ng dÃƒÂ¹ng phÃ†Â°Ã†Â¡ng thÃ¡Â»Â©c chuyÃ¡Â»Æ’n khoÃ¡ÂºÂ£n', 'error', 3800)
      return
    }
    if (errCode === 'ORDER_NOT_FOUND') {
      showToast('KhÃƒÂ´ng tÃƒÂ¬m thÃ¡ÂºÂ¥y Ã„â€˜Ã†Â¡n hÃƒÂ ng Ã„â€˜Ã¡Â»Æ’ thanh toÃƒÂ¡n lÃ¡ÂºÂ¡i', 'error', 3800)
      return
    }
    if (errCode === 'INVALID_ORDER_AMOUNT') {
      showToast('Ã„ÂÃ†Â¡n hÃƒÂ ng cÃƒÂ³ sÃ¡Â»â€˜ tiÃ¡Â»Ân khÃƒÂ´ng hÃ¡Â»Â£p lÃ¡Â»â€¡ Ã„â€˜Ã¡Â»Æ’ thanh toÃƒÂ¡n', 'error', 3800)
      return
    }
    try { if (payTab && !payTab.closed) payTab.close() } catch (_) { }
    const msg = err.response?.data?.error || err.message || 'KhÃƒÂ´ng thÃ¡Â»Æ’ mÃ¡Â»Å¸ lÃ¡ÂºÂ¡i thanh toÃƒÂ¡n cho Ã„â€˜Ã†Â¡n nÃƒÂ y'
    showToast('KhÃƒÂ´ng thÃ¡Â»Æ’ mÃ¡Â»Å¸ lÃ¡ÂºÂ¡i thanh toÃƒÂ¡n: ' + msg, 'error', 4000)
  }
}

// Ã¢â€â‚¬Ã¢â€â‚¬ WALLET CONFIG (thay thÃƒÂ´ng tin ngÃƒÂ¢n hÃƒÂ ng Ã¡Â»Å¸ Ã„â€˜ÃƒÂ¢y) Ã¢â€â‚¬Ã¢â€â‚¬
const BANK_CONFIG = {
  bankId: 'MB',
...
async function copyBankValue(value) {
  try {
    ...
    showToast('Ã„ÂÃƒÂ£ sao chÃƒÂ©p', 'success', 1500)
  } catch (_) {
    showToast('KhÃƒÂ´ng thÃ¡Â»Æ’ sao chÃƒÂ©p', 'error', 1500)
  }
}
...
function onOrderMarkedPaid(orderCode) {
  ...
  showToast('Ã„ÂÃƒÂ£ thanh toÃƒÂ¡n thÃƒÂ nh cÃƒÂ´ng vÃƒÂ  ghi nhÃ¡ÂºÂ­n Ã„â€˜Ã†Â¡n hÃƒÂ ng', 'success', 4500)
  const userMenuContent = document.getElementById('userMenuContent')
  if (userMenuContent && userMenuContent.textContent && userMenuContent.textContent.includes('LÃ¡Â»â€¹ch sÃ¡Â»Â­ mua hÃƒÂ ng')) {
    showUserOrders()
  }
...
function handlePaymentReturnFlow() {
  ...
  if (payState === 'success' && orderCode) {
    ...
    showToast('Thanh toÃƒÂ¡n ' + providerLabel + ' thÃƒÂ nh cÃƒÂ´ng', 'success', 3000)
    return
  }

  if (payState === 'cancel') {
    showToast('BÃ¡ÂºÂ¡n Ã„â€˜ÃƒÂ£ hÃ¡Â»Â§y thanh toÃƒÂ¡n ' + providerLabel, 'error', 3000)
  }
  cleanPaymentQueryParams()
}
...
function showWalletInMenu() {
    ...
    if (!currentUser) {
        content.innerHTML = '<div class="text-center py-8 text-gray-400"><i class="fas fa-lock text-3xl mb-3"></i><p>Vui lÃƒÂ²ng Ã„â€˜Ã„Æ’ng nhÃ¡ÂºÂ­p Ã„â€˜Ã¡Â»Æ’ nÃ¡ÂºÂ¡p tiÃ¡Â»Ân</p></div>'
        return
    }
    ...
    html += '<div><p class="text-xs text-gray-500">SÃ¡Â»â€˜ dÃ†Â° vÃƒÂ­</p><p class="text-xl font-bold text-pink-600">' + fmtBalance(currentUser.balance) + '</p></div>'
    html += '<i class="fas fa-wallet text-3xl text-pink-300"></i></div>'
    html += '<h4 class="font-semibold text-gray-700 text-sm mb-2"><i class="fas fa-coins text-pink-400 mr-1"></i>ChÃ¡Â»Ân sÃ¡Â»â€˜ tiÃ¡Â»Ân</h4>'
    ...
    for (var i = 0; i < amounts.length; i++) {
        ...
        html += '<button onclick="selectTopupAmount(' + v + ')" class="topup-amt-btn border-2 rounded-xl py-2 text-xs font-semibold transition ' + cls + '" data-amt="' + v + '">' + new Intl.NumberFormat('vi-VN').format(v) + 'Ã„â€˜</button>'
    }
    html += '</div>'
    html += '<div class="flex items-center gap-2 mb-4"><input id="customTopupAmt" type="number" placeholder="SÃ¡Â»â€˜ tiÃ¡Â»Ân khÃƒÂ¡c..." class="flex-1 border-2 border-gray-200 rounded-xl px-3 py-2 text-sm focus:border-pink-400 outline-none" oninput="onCustomAmountInput(this.value)"><span class="text-gray-400 text-sm font-semibold">Ã„â€˜</span></div>'
    html += '<div class="bg-white border-2 border-gray-100 rounded-2xl p-4 text-center">'
    html += '<p class="text-sm font-semibold text-gray-700 mb-3"><i class="fas fa-qrcode text-pink-400 mr-1"></i>QuÃƒÂ©t mÃƒÂ£ QR Ã„â€˜Ã¡Â»Æ’ thanh toÃƒÂ¡n</p>'
    ...
    html += '<div class="flex justify-between items-center bg-gray-50 rounded-lg px-3 py-2"><span class="text-gray-500">NgÃƒÂ¢n hÃƒÂ ng</span><span class="font-bold text-gray-800">MB Bank</span></div>'
    html += '<div class="flex justify-between items-center bg-gray-50 rounded-lg px-3 py-2"><span class="text-gray-500">SÃ¡Â»â€˜ TK</span><span class="font-bold text-gray-800">' + BANK_CONFIG.accountNo + ' <i class="fas fa-copy text-gray-400 cursor-pointer ml-1 copy-btn" data-copy="' + BANK_CONFIG.accountNo + '"></i></span></div>'
    html += '<div class="flex justify-between items-center bg-gray-50 rounded-lg px-3 py-2"><span class="text-gray-500">ChÃ¡Â»Â§ TK</span><span class="font-bold text-gray-800">' + BANK_CONFIG.accountName + '</span></div>'
    html += '<div class="bg-amber-50 border border-amber-200 rounded-lg px-3 py-2"><p class="text-amber-600 font-semibold mb-0.5">NÃ¡Â»â„¢i dung CK (BÃ¡ÂºÂ®T BUÃ¡Â»ËœC)</p><div class="flex justify-between items-center"><span class="font-mono font-bold text-amber-800 text-sm">' + tc + '</span><i class="fas fa-copy text-amber-400 cursor-pointer copy-btn" data-copy="' + tc + '"></i></div></div>'
    html += '<div class="flex justify-between items-center bg-gray-50 rounded-lg px-3 py-2"><span class="text-gray-500">SÃ¡Â»â€˜ tiÃ¡Â»Ân</span><span class="font-bold text-pink-600" id="qrAmountDisplay">' + fmtBalance(selectedTopupAmount) + '</span></div>'
    html += '</div></div>'
    html += '<div class="mt-3 bg-blue-50 border border-blue-200 rounded-xl px-3 py-2 text-xs text-blue-700 space-y-1">'
    html += '<p class="font-semibold"><i class="fas fa-info-circle mr-1"></i>LÃ†Â°u ÃƒÂ½:</p>'
    html += '<p>Ã¢â‚¬Â¢ NÃ¡Â»â„¢i dung CK phÃ¡ÂºÂ£i <strong>CHÃƒÂNH XÃƒÂC</strong></p>'
    html += '<p>Ã¢â‚¬Â¢ TiÃ¡Â»Ân sÃ¡ÂºÂ½ Ã„â€˜Ã†Â°Ã¡Â»Â£c cÃ¡Â»â„¢ng <strong>tÃ¡Â»Â± Ã„â€˜Ã¡Â»â„¢ng</strong> trong 1-5 phÃƒÂºt</p>'
    html += '<p>Ã¢â‚¬Â¢ LiÃƒÂªn hÃ¡Â»â€¡ admin nÃ¡ÂºÂ¿u khÃƒÂ´ng nhÃ¡ÂºÂ­n Ã„â€˜Ã†Â°Ã¡Â»Â£c tiÃ¡Â»Ân sau 10 phÃƒÂºt</p>'
    html += '</div>'
...
function copyText(text) {
    navigator.clipboard.writeText(text).then(function () { showToast('Ã„ÂÃƒÂ£ sao chÃƒÂ©p: ' + text, 'success') })
}
...
// Ã¢â€â‚¬Ã¢â€â‚¬ BALANCE POLLING & SUCCESS NOTIFICATION Ã¢â€â‚¬Ã¢â€â‚¬
...
function showTopupSuccessModal(amount) {
  ...
  overlay.innerHTML = '<div style="background:white;border-radius:1.5rem;padding:2.5rem 2rem;text-align:center;max-width:340px;width:90%;box-shadow:0 25px 50px rgba(0,0,0,0.25);animation:scaleIn 0.4s cubic-bezier(0.34,1.56,0.64,1)">'
    ...
    + '<h3 style="color:#059669;font-size:1.25rem;font-weight:700;margin-bottom:0.5rem">Ã„ÂÃƒÂ£ nÃ¡ÂºÂ¡p tiÃ¡Â»Ân thÃƒÂ nh cÃƒÂ´ng!</h3>'
    + '<p style="color:#047857;font-size:1.75rem;font-weight:800">+' + fmtBalance(amount) + '</p>'
    + '<p style="color:#6b7280;font-size:0.8rem;margin-top:0.5rem">SÃ¡Â»â€˜ dÃ†Â° mÃ¡Â»â€ºi: ' + fmtBalance(currentUser.balance) + '</p>'
