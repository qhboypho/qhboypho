...
<title>QH Clothes – Phong Cách Th?i Trang Hot Trend</title>
<meta name="description" content="Th?i trang hot trend cho gi?i tr?, c?p nh?p các m?u m?i và th?nh hành nh?t. Mua s?m phong cách, d?n d?u xu hu?ng, giá c?c ch?t t?i QH Clothes.">
<meta name="keywords" content="QH Boypho, QH Clothes, boypho, girlpho, Hi?u Qu?nh, th?i trang hot trend, th?i trang gi?i tr?, qu?n áo nam n?, local brand, áo thun unisex, áo khoác nam n?, m?u m?i th?nh hành">
<meta name="author" content="QH Clothes">
<meta name="robots" content="index, follow">
<meta property="og:title" content="QH Clothes – Phong Cách Th?i Trang Hot Trend">
<meta property="og:description" content="Th?i trang hot trend cho gi?i tr?, c?p nh?p các m?u m?i và th?nh hành nh?t.">
<meta property="og:image" content="/qh-logo.png">
<meta property="og:type" content="website">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="QH Clothes – Phong Cách Th?i Trang Hot Trend">
<meta name="twitter:description" content="Th?i trang hot trend cho gi?i tr?, c?p nh?p các m?u m?i và th?nh hành nh?t.">
...
<nav class="navbar-blur fixed top-0 left-0 right-0 z-50 border-b border-white/10">
  <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
    ...
    <div class="hidden md:flex items-center gap-6 text-sm text-gray-300">
      ...
      <a href="#about" class="hover:text-pink-400 transition">V? chúng tôi</a>
      <a href="#contact" class="hover:text-pink-400 transition">Liên h?</a>
    </div>
  ...
  <div id="mobileMenu" class="hidden md:hidden border-t border-white/10 py-4 px-4 flex flex-col gap-3">
    ...
    <a href="#about" class="text-gray-300 hover:text-pink-400" onclick="toggleMobileMenu()">V? chúng tôi</a>
    <a href="#contact" class="text-gray-300 hover:text-pink-400" onclick="toggleMobileMenu()">Liên h?</a>
  </div>
</nav>
  ...
  <div class="max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
    <div>
      ...
      <h1 class="font-display text-5xl md:text-6xl text-white font-bold leading-tight mb-6">
        Phong Cách<br><span style="background:linear-gradient(135deg,#e84393,#f39c12);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent">Không Gi?i H?n</span>
      </h1>
      <p class="text-gray-300 text-lg mb-8 leading-relaxed">Khám phá b? suu t?p th?i trang cao c?p dành cho c? nam l?n n?. Ch?t lu?ng v?i premium, thi?t k? tinh t? – th? hi?n cá tính c?a b?n.</p>
      ...
      <div class="mt-12 grid grid-cols-3 gap-6">
        ...
        <div class="text-center"><p class="text-3xl font-bold text-white">4.9?</p><p class="text-gray-400 text-sm">Ðánh giá</p></div>
      </div>
    </div>
    <div class="flex justify-center" id="heroBannersWrapper">
      <!-- Collapsed / stacked state -->
      <div id="heroBannersCollapsed" title="Click d? xem thêm">
    ...
    <div id="heroBannersExpanded" onclick="handleBannerOverlayClick(event)">
      <p id="heroBannersExpandedTitle">?? Ðang th?nh hành</p>
      <p id="heroBannersExpandedSubtitle" class="text-white/70 text-xs md:text-sm text-center mb-4">Ðây là nh?ng s?n ph?m hot nh?t và dang du?c d?t mua nhi?u nh?t ? th?i di?m hi?n t?i.</p>
...
<section class="sticky top-16 z-40 bg-white shadow-sm border-b" id="filterBar">
  <div class="max-w-7xl mx-auto px-4 py-3 flex gap-3 overflow-x-auto scrollbar-none items-center">
    ...
    <div class="relative">
      <input type="text" id="searchInput" placeholder="Tìm s?n ph?m..." 
...
<section class="max-w-7xl mx-auto px-4 py-16" id="products">
  <div class="text-center mb-12">
    ...
    <p class="text-gray-500 mt-3">Nh?ng thi?t k? du?c yêu thích nh?t t? b? suu t?p c?a chúng tôi</p>
  </div>
  ...
  <div id="emptyState" class="hidden text-center py-20">
    ...
    <p class="text-gray-400 text-lg">Không tìm th?y s?n ph?m nào</p>
  </div>
</section>
...
<section class="bg-white py-16" id="about">
  <div class="max-w-7xl mx-auto px-4">
    <div class="grid md:grid-cols-4 gap-8 text-center">
      <div class="p-6"><div class="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mx-auto mb-4"><i class="fas fa-truck text-pink-500 text-2xl"></i></div><h3 class="font-semibold text-gray-800 mb-2">Giao hàng toàn qu?c</h3><p class="text-gray-500 text-sm">Giao t?n noi, nhanh chóng, an toàn</p></div>
      ...
      <div class="p-6"><div class="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mx-auto mb-4"><i class="fas fa-undo text-pink-500 text-2xl"></i></div><h3 class="font-semibold text-gray-800 mb-2">Ð?i tr? d? dàng</h3><p class="text-gray-500 text-sm">7 ngày d?i tr?, không c?n lý do</p></div>
      <div class="p-6"><div class="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mx-auto mb-4"><i class="fas fa-headset text-pink-500 text-2xl"></i></div><h3 class="font-semibold text-gray-800 mb-2">H? tr? 24/7</h3><p class="text-gray-500 text-sm">Tu v?n nhi?t tình, t?n tâm</p></div>
    </div>
  </div>
</section>
...
<footer class="gradient-hero text-white py-12" id="contact">
  <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8">
    <div>
      ...
      <p class="text-gray-400 text-sm leading-relaxed">Thuong hi?u th?i trang Vi?t Nam cao c?p, mang phong cách hi?n d?i d?n v?i m?i ngu?i.</p>
    </div>
    <div>
      <h4 class="font-semibold mb-4">Liên k?t nhanh</h4>
    ...
    <div>
      <h4 class="font-semibold mb-4">Liên h?</h4>
      <div class="flex flex-col gap-2 text-gray-400 text-sm">
        ...
        <p><i class="fas fa-map-marker-alt mr-2 text-pink-400"></i>TP. H? Chí Minh, Vi?t Nam</p>
      </div>
    </div>
  </div>
...
<div id="orderOverlay" class="fixed inset-0 overlay z-50 hidden flex items-center justify-center p-4">
  <div class="popup-card bg-white rounded-3xl shadow-2xl w-full max-w-md md:max-w-[56rem] max-h-[90vh] overflow-y-auto" id="orderPopupCard">
    <div class="sticky top-0 bg-white rounded-t-3xl border-b px-6 py-4 flex items-center justify-between">
      <h3 class="font-display text-xl font-bold text-gray-900">Ð?t hàng nhanh</h3>
      ...
      <div class="space-y-4">
        ...
        <div id="fieldName">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-user text-pink-400 mr-1"></i>H? và tên *
          </label>
          <input type="text" id="orderName" placeholder="Nh?p h? và tên"
        ...
        <div id="fieldAddress">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-map-marker-alt text-pink-400 mr-1"></i>Ð?a ch? giao hàng *
          </label>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2.5">
            <div id="orderProvinceDropdown" class="relative">
              <button type="button" id="orderProvinceTrigger" onclick="toggleAddressDropdown('order','province')"
                ...
                <span id="orderProvinceLabel" class="text-gray-500">Ch?n t?nh/thành</span>
              ...
              <div id="orderProvinceMenu" class="hidden absolute z-[90] mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                <div class="p-2 border-b bg-gray-50">
                  <input type="text" id="orderProvinceSearch" placeholder="Tìm t?nh/thành..."
            ...
            <div id="orderCommuneDropdown" class="relative">
              <button type="button" id="orderCommuneTrigger" onclick="toggleAddressDropdown('order','commune')"
                class="w-full border rounded-xl px-3.5 py-2.5 text-sm bg-white text-left flex items-center justify-between focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
                <span id="orderCommuneLabel" class="text-gray-500">Ch?n phu?ng/xã</span>
                <i class="fas fa-chevron-down text-gray-400 text-xs"></i>
              </button>
              <div id="orderCommuneMenu" class="hidden absolute z-[90] mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                <div class="p-2 border-b bg-gray-50">
                  <input type="text" id="orderCommuneSearch" placeholder="Tìm phu?ng/xã..."
          ...
          <input type="text" id="orderAddress"
            readonly
            placeholder="Ð?a ch? d?y d? s? t? d?ng ghép t?i dây"
        ...
        <div id="fieldColor">
          <label class="block text-sm font-semibold text-gray-700 mb-2 field-title">
            <i class="fas fa-palette text-pink-400 mr-1"></i>Màu s?c *
          </label>
        ...
        <div id="fieldVoucher">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-tag text-pink-400 mr-1"></i>Mã gi?m giá (tu? ch?n)
          </label>
          <div class="flex gap-2">
            <input type="text" id="orderVoucher" placeholder="Nh?p mã voucher..."
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-1.5">
            <i class="fas fa-sticky-note text-pink-400 mr-1"></i>Ghi chú (tu? ch?n)
          </label>
          <input type="text" id="orderNote" placeholder="Ghi chú cho don hàng..."
            class="w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
        </div>

        <div id="fieldPaymentMethod">
          <label class="block text-sm font-semibold text-gray-700 mb-1.5 field-title">
            <i class="fas fa-credit-card text-pink-400 mr-1"></i>Ch?n phuong th?c thanh toán *
          </label>
          <p class="text-xs text-red-500 mb-2">Tru?ng này là b?t bu?c</p>
          <div class="space-y-2">
            ...
            <div class="w-full flex items-center gap-2 border rounded-xl px-3 py-2.5 hover:border-pink-400 transition">
              ...
              <button type="button" class="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1"
                ...
                Liên k?t <i class="fas fa-chevron-right text-xs"></i>
              </button>
            </div>
            ...
            <button type="button" class="payment-method-btn w-full flex items-center gap-3 border rounded-xl px-3 py-2.5 text-left hover:border-pink-400 transition"
              ...
              <span class="block text-sm font-semibold text-gray-800">Ví di?n t? MoMo</span>
            </button>
            ...
            <button type="button" class="payment-method-btn w-full flex items-center gap-3 border rounded-xl px-3 py-2.5 text-left hover:border-pink-400 transition"
              ...
              <span class="block text-sm font-semibold text-gray-800">Chuy?n kho?n ngân hàng</span>
            </button>
          </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-pink-50 to-red-50 rounded-2xl p-4 space-y-1.5">
          <div id="subtotalRow" class="flex justify-between items-center hidden">
            <span class="text-sm text-gray-500">T?m tính:</span>
          ...
          <div id="discountRow" class="flex justify-between items-center hidden">
            <span class="text-sm text-green-600 font-medium"><i class="fas fa-tag mr-1"></i>Gi?m giá:</span>
  ...
  <div class="popup-card bg-white rounded-3xl shadow-2xl w-full max-w-md max-h-[92vh] overflow-y-auto">
    <div class="sticky top-0 bg-white rounded-t-3xl border-b px-6 py-4 flex items-center justify-between">
      <h3 class="font-display text-xl font-bold text-gray-900">
        <i class="fas fa-qrcode text-pink-500 mr-2"></i>Quét mã QR d? thanh toán
      </h3>
    ...
    <div class="px-6 py-5">
      <div class="border rounded-2xl p-4 bg-gray-50">
        <div class="flex justify-center mb-3">
          <img id="orderBankQrImg" src="" alt="VietQR thanh toán don hàng" class="w-56 h-56 object-contain rounded-xl border bg-white">
        </div>
        <div class="space-y-2 text-sm">
          ...
          <div class="flex justify-between items-center bg-white rounded-lg px-3 py-2 border">
            <span class="text-gray-500">Mã don</span>
      ...
      <div class="mt-4 bg-blue-50 border border-blue-200 rounded-xl px-3 py-2 text-xs text-blue-700">
        Sau khi chuy?n kho?n, don hàng s? du?c xác nh?n khi shop d?i soát giao d?ch.
      </div>
    </div>
  </div>
</div>
...
<div id="orderPaidNoticeOverlay" class="fixed inset-0 z-[80] hidden items-center justify-center bg-black/30 p-4">
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-xs p-5 text-center">
    ...
    <p class="text-green-600 font-bold text-lg">Ðã thanh toán thành công</p>
    <p class="text-sm text-gray-600 mt-1">Ðon hàng dã du?c ghi nh?n.</p>
  ...
  <div id="cartModal" class="cart-modal absolute right-0 top-0 bottom-0 w-full max-w-lg bg-white flex flex-col shadow-2xl">
    ...
    <div id="cartHeader" class="flex items-center justify-between px-5 py-4 border-b bg-gradient-to-r from-gray-900 to-gray-800 text-white flex-shrink-0">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 id="cartTitle" class="font-display text-lg font-bold">Gi? hàng</h2>
          <p id="cartSubtitle" class="text-xs text-gray-300">Chua có s?n ph?m</p>
        </div>
      </div>
    ...
    <div id="cartStep1" class="flex flex-col flex-1 overflow-hidden">
      ...
      <div id="cartCheckAllBar" class="hidden flex items-center gap-3 px-5 py-3 bg-gray-50 border-b flex-shrink-0">
        ...
        <button onclick="removeChecked()" id="deleteCheckedBtn" class="hidden text-xs text-red-500 hover:text-red-600 font-medium transition">
          <i class="fas fa-trash mr-1"></i>Xoá dã ch?n
        </button>
      </div>
      ...
      <div id="cartFooter" class="hidden flex-shrink-0 border-t bg-white px-5 py-4">
        ...
        <button onclick="proceedToCheckout()" id="checkoutBtn"
          ...
          <i class="fas fa-credit-card mr-2"></i>Xác nh?n & Ð?t hàng
        </button>
      </div>
    </div>
    ...
    <div id="cartStep2" class="hidden flex-col flex-1 overflow-hidden checkout-slide">
      ...
      <div class="flex-1 overflow-y-auto px-5 py-4">
        ...
        <div class="space-y-4">
          ...
          <div id="ckFieldName">
            ...
            <input type="text" id="ckName" placeholder="Nh?p h? và tên"
              class="w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2.5">
              <div id="ckProvinceDropdown" class="relative">
                <button type="button" id="ckProvinceTrigger" onclick="toggleAddressDropdown('ck','province')"
                  class="w-full border rounded-xl px-3.5 py-2.5 text-sm bg-white text-left flex items-center justify-between focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
                  <span id="ckProvinceLabel" class="text-gray-500">Ch?n t?nh/thành</span>
                  <i class="fas fa-chevron-down text-gray-400 text-xs"></i>
                </button>
                <div id="ckProvinceMenu" class="hidden absolute z-[90] mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                  <div class="p-2 border-b bg-gray-50">
                    <input type="text" id="ckProvinceSearch" placeholder="Tìm t?nh/thành..."
              ...
              <div id="ckCommuneDropdown" class="relative">
                <button type="button" id="ckCommuneTrigger" onclick="toggleAddressDropdown('ck','commune')"
                  class="w-full border rounded-xl px-3.5 py-2.5 text-sm bg-white text-left flex items-center justify-between focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
                  <span id="ckCommuneLabel" class="text-gray-500">Ch?n phu?ng/xã</span>
                  <i class="fas fa-chevron-down text-gray-400 text-xs"></i>
                </button>
                <div id="ckCommuneMenu" class="hidden absolute z-[90] mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                  <div class="p-2 border-b bg-gray-50">
                    <input type="text" id="ckCommuneSearch" placeholder="Tìm phu?ng/xã..."
          ...
          <div id="ckFieldVoucher">
            ...
            <div class="flex gap-2">
              <input type="text" id="ckVoucher" placeholder="Nh?p mã voucher..."
                class="flex-1 border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200 uppercase tracking-wider"
                oninput="this.value=this.value.toUpperCase()">
          ...
          <div>
            ...
            <input type="text" id="ckNote" placeholder="Ghi chú cho don hàng..."
              class="w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-200">
          </div>
          <!-- Total box -->
          <div class="bg-gradient-to-r from-pink-50 to-red-50 rounded-2xl p-4 space-y-1.5">
      ...
      <div class="flex-shrink-0 border-t bg-white px-5 py-4">
        <button onclick="submitCartOrder()" id="submitCartBtn"
          ...
          <i class="fas fa-shopping-cart mr-2"></i>Ð?t hàng ngay
        </button>
      </div>
    </div>
  ...
  <div id="userMenuPanel" class="user-menu-panel absolute right-0 top-0 bottom-0 w-full max-w-sm bg-white flex flex-col shadow-2xl">
    ...
    <div class="bg-gradient-to-r from-gray-900 to-gray-800 text-white px-5 py-5 flex-shrink-0">
      <div class="flex items-center justify-between mb-4">
        <h2 class="font-display text-lg font-bold">Tài kho?n</h2>
      ...
      <div id="userMenuGuest">
        <p class="text-gray-300 text-sm mb-3">Ðang nh?p d? luu l?ch s? don hàng</p>
    ...
    <div class="flex-1 overflow-y-auto px-4 py-4">
      <nav class="space-y-1">
        <button onclick="showUserAccount()" class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-pink-50 hover:text-pink-600 transition text-sm font-medium text-left">
          <i class="fas fa-user-circle w-5 text-pink-400"></i>Qu?n lý tài kho?n
        </button>
        <button onclick="showUserOrders()" id="userOrdersBtn" class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-pink-50 hover:text-pink-600 transition text-sm font-medium text-left">
          <i class="fas fa-clipboard-list w-5 text-pink-400"></i>L?ch s? mua hàng
        </button>
        <button onclick="showWalletInMenu()" class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-pink-50 hover:text-pink-600 transition text-sm font-medium text-left">
          <i class="fas fa-wallet w-5 text-pink-400"></i>N?p ti?n vào ví
    ...
    <div id="userMenuLogoutArea" class="hidden flex-shrink-0 border-t px-5 py-4">
      <button onclick="logoutUser()" class="w-full flex items-center justify-center gap-2 border-2 border-red-200 text-red-500 py-2.5 rounded-xl font-semibold text-sm hover:bg-red-50 transition">
        <i class="fas fa-sign-out-alt"></i>Ðang xu?t
      </button>
    </div>
  </div>
</div>
...
function renderAddressDropdownList(scope, type, keyword = '') {
  ...
  const placeholder = String(selectEl.options?.[0]?.textContent || (type === 'province' ? 'Ch?n t?nh/thành' : 'Ch?n phu?ng/xã'))
  ...
  if (!filtered.length) {
    optionsEl.innerHTML = '<div class="px-3 py-2 text-sm text-gray-400">Không tìm th?y k?t qu?</div>'
    return
  }
...
function renderProvinceOptionsForScope(scope, keyword = '') {
  ...
  setAddressSelectOptions(provinceEl, filtered, filtered.length ? 'Ch?n t?nh/thành' : 'Không tìm th?y t?nh/thành')
...
function renderCommuneOptionsForScope(scope, keyword = '') {
  ...
  const placeholder = provinceCode
    ? (filtered.length ? 'Ch?n phu?ng/xã' : 'Không tìm th?y phu?ng/xã')
    : 'Ch?n phu?ng/xã'
...
function resetAddressScope(scope) {
  ...
  if (communeEl) setAddressSelectOptions(communeEl, [], 'Ch?n phu?ng/xã')
...
async function onAddressProvinceChange(scope) {
  ...
  addressDropdownSearchState[scope + ':commune'] = ''
  setAddressSelectOptions(communeEl, [], selectedCode ? 'Ðang t?i phu?ng/xã...' : 'Ch?n phu?ng/xã')
  renderAddressDropdownList(scope, 'commune', '')
  if (!selectedCode) {
  ...
  try {
    ...
    setAddressSelectOptions(communeEl, [], 'Không t?i du?c phu?ng/xã')
    showToast('Không t?i du?c danh sách phu?ng/xã. Vui lòng th? l?i.', 'error', 4500)
  }
  syncAddressFullText(scope)
  if (scope === 'ck') clearCheckoutError(ids.fieldId)
  else clearFieldError(ids.fieldId)
...
async function loadProducts() {
  try {
    ...
    document.getElementById('productsGrid').innerHTML = '<div class="col-span-4 text-center text-gray-400 py-12"><i class="fas fa-exclamation-circle text-4xl mb-3"></i><p>Không th? t?i s?n ph?m</p></div>'
  }
}
    ...
    <div class="bg-white rounded-2xl overflow-hidden card-hover shadow-sm border border-gray-100 cursor-pointer" onclick="showDetail(\${p.id})">
      ...
      <div class="p-3 md:p-4">
        ...
        <div class="flex gap-2">
          ...
          <button onclick="event.stopPropagation();addToCartFromCard(event, \${p.id})" title="Thêm vào gi? hàng"
...
async function showDetail(id) {
  try {
    ...
    <div class="grid md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <div class="mb-4">
          <p class="text-sm font-semibold mb-2">Màu s?c: <span class="text-pink-500" id="detailColorLabel"></span></p>
            ...
            \${detailColorOptions.map((item, idx) => \`<button type="button"
              ...
              <div class="relative aspect-square bg-gray-100 overflow-hidden">
                \${item.image
                  ...
                  : \`<div class="w-full h-full flex items-center justify-center text-gray-300 text-xs">Không có ?nh</div>\`}
              </div>
  ...
  } catch(e) { showToast('Không th? t?i chi ti?t s?n ph?m', 'error') }
}
...
async function openOrder(id) {
  try {
    ...
    \`).join('') : '<p class="text-gray-400 text-sm">Không có l?a ch?n màu</p>'
...
async function addToCartFromCard(evt, id) {
  try {
    ...
    showToast('Ðã thêm "' + p.name + '" vào gi? hàng!', 'success', 2500)
  } catch(e) { showToast('L?i khi thêm vào gi?', 'error') }
}
...
async function applyVoucher() {
  ...
  if (!code) {
    ...
    statusEl.innerHTML = '<i class="fas fa-times-circle mr-1"></i>Vui lòng nh?p mã voucher'
  ...
  try {
    ...
    statusEl.innerHTML = \`<i class="fas fa-check-circle text-green-500"></i>Áp d?ng thành công! Gi?m <strong>\${fmtPrice(appliedVoucher.discount_amount)}</strong>\`
    statusEl.classList.remove('hidden')
    updateOrderTotal()
    ...
    const msg = errCode === 'VOUCHER_LIMIT' ? 'Voucher dã h?t lu?t s? d?ng'
              : errCode === 'INVALID_VOUCHER' ? 'Mã không h?p l? ho?c dã h?t h?n'
              : 'Không th? áp d?ng mã này'
    ...
    btn.disabled = false
    btn.innerHTML = appliedVoucher ? '<i class="fas fa-check mr-1"></i>Ðã áp d?ng' : 'Áp d?ng'
...
async function submitOrder() {
  ...
  btn.disabled = true
  btn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Ðang x? lý...'
  let payTabRef = null
  ...
  try {
    ...
    if (selectedPaymentMethod === 'BANK_TRANSFER') {
      ...
      try {
        ...
        showToast('PayOS t?m l?i, dang chuy?n sang QR d? phòng.', 'error', 4500)
      }
      if (payosData?.alreadyPaid) {
        onOrderMarkedPaid(orderCode)
        showToast('Ðon ' + orderCode + ' dã du?c thanh toán tru?c dó.', 'success', 4500)
        return
      }
      ...
      if (checkoutUrl) {
        ...
        if (payTab) {
          ...
          showToast(\`Ðon \${orderCode}: dã m? tab PayOS, vui lòng hoàn t?t thanh toán.\`, 'success', 5000)
        } else {
          showToast('Trình duy?t dang ch?n popup, hi?n th? QR d? phòng d? b?n thanh toán th? công.', 'error', 5000)
        ...
        showToast(\`Ðon hàng \${orderCode} dã t?o. Vui lòng chuy?n kho?n d? hoàn t?t.\`, 'success', 5000)
      }
    } else if (selectedPaymentMethod === 'ZALOPAY') {
      let zaloData = null
      try {
      ...
      if (!checkoutUrl) {
        try { if (payTabRef && !payTabRef.closed) payTabRef.close() } catch (_) { }
        showToast('Không t?o du?c liên k?t thanh toán ZaloPay.', 'error', 4500)
        return
      }
      ...
      if (payTab) {
        ...
        startOrderPaymentPolling(orderCode)
        showToast(\`Ðon \${orderCode}: dã m? tab ZaloPay, vui lòng quét QR d? thanh toán.\`, 'success', 5000)
      } else {
        // Fallback: popup b? ch?n, di?u hu?ng luôn t?i tab hi?n t?i
        startOrderPaymentPolling(orderCode)
        window.location.href = checkoutUrl
      }
    } else {
      showToast(\`?? Ð?t hàng thành công! Mã don: \${orderCode}\`, 'success', 5000)
    }
  } catch(e) {
    try { if (payTabRef && !payTabRef.closed) payTabRef.close() } catch (_) { }
    const errCode = e.response?.data?.error
    if (errCode === 'INVALID_VOUCHER' || errCode === 'VOUCHER_LIMIT') {
      showToast('Voucher không còn hi?u l?c, vui lòng th? l?i', 'error')
      appliedVoucher = null
      updateOrderTotal()
      document.getElementById('voucherBtn').innerHTML = 'Áp d?ng'
      ...
      showToast('Ð?t hàng th?t b?i, th? l?i sau', 'error')
    }
  } finally {
    btn.disabled = false
    btn.innerHTML = '<i class="fas fa-shopping-cart mr-2"></i>Ð?t hàng ngay'
  }
}
...
function openCart() {
  ...
  document.getElementById('cartTitle').textContent = 'Gi? hàng'
  document.body.style.overflow = 'hidden'
}
function closeCart() {
...
async function proceedToCheckout() {
  const checked = cart.filter(i=>i.checked)
  if (checked.length === 0) { showToast('Vui lòng ch?n ít nh?t 1 s?n ph?m','error'); return }
  try {
    await ensureAddressKitReady()
  } catch (_) {
    showToast('Không t?i du?c danh m?c d?a ch?, vui lòng th? l?i.', 'error', 4500)
    return
  }
  // Build summary
  ...
  document.getElementById('ckVoucherBtn').textContent = 'Áp d?ng'
  ...
  document.getElementById('cartTitle').textContent = 'Xác nh?n don hàng'
...
async function applyCkVoucher() {
  ...
  try {
    ...
    ckAppliedVoucher = null
    const errCode = err.response?.data?.error
    const msg = errCode==='VOUCHER_LIMIT'?'Voucher dã h?t lu?t':errCode==='INVALID_VOUCHER'?'Mã không h?p l? ho?c h?t h?n':'Không th? áp d?ng'
    statusEl.className='mt-2 voucher-error rounded-xl px-3 py-2 text-sm text-red-600 font-medium flex items-center gap-1'
    statusEl.innerHTML='<i class="fas fa-times-circle mr-1"></i>' + msg
    statusEl.classList.remove('hidden')
    ...
    btn.disabled=false
    btn.innerHTML = ckAppliedVoucher ? '<i class="fas fa-check mr-1"></i>Ðã áp d?ng' : 'Áp d?ng'
...
async function submitCartOrder() {
  ...
  try {
    ...
    const errCode = e.response?.data?.error
    if (errCode==='INVALID_VOUCHER'||errCode==='VOUCHER_LIMIT') {
      showToast('Voucher không còn hi?u l?c','error')
      ckAppliedVoucher=null; updateCkTotal()
      document.getElementById('ckVoucherBtn').innerHTML='Áp d?ng'
      document.getElementById('ckVoucherBtn').className='px-4 py-2.5 bg-gray-800 hover:bg-gray-700 text-white rounded-xl text-sm font-semibold transition whitespace-nowrap'
    } else { showToast('Ð?t hàng th?t b?i, th? l?i sau','error') }
  } finally {
    btn.disabled=false
    btn.innerHTML='<i class="fas fa-shopping-cart mr-2"></i>Ð?t hàng ngay'
  }
...
function renderCollapsedBanners(banners) {
  ...
  if (!banners.length) {
    container.innerHTML = \`<div class="relative w-full h-full rounded-3xl border border-white/20 bg-white/5 flex items-center justify-center text-center px-6">
      <div>
        ...
        <p class="text-white/80 text-sm font-medium">Chua có s?n ph?m th?nh hành</p>
      </div>
    </div>\`
    return
  }
  ...
  <div class="absolute flex items-center gap-1.5 bg-white/20 backdrop-blur-sm rounded-full px-3 py-1.5 text-white text-xs font-medium cursor-pointer hover:bg-white/30 transition whitespace-nowrap" style="bottom:-28px;left:50%;transform:translateX(-50%);z-index:5" onclick="expandBanners()">
    <i class="fas fa-expand-alt mr-1 text-pink-300"></i>Các m?u th?nh hành
  </div>\`
...
function renderExpandedBanners(banners) {
  ...
  if (!inner) return
  if (title) title.textContent = \`?? Ðang th?nh hành (\${banners.length} m?u)\`
...
ensureAddressKitReady().catch(() => {
  showToast('Không t?i du?c danh m?c t?nh/phu?ng. B?n có th? th? l?i sau.', 'error', 4500)
})
...
async function logoutUser() {
  ...
  updateUserUI()
  closeUserMenu()
  showToast('Ðã dang xu?t thành công', 'success')
}

function showUserAccount() {
  const content = document.getElementById('userMenuContent')
  if (!currentUser) {
    content.innerHTML = '<div class="text-center py-8 text-gray-400"><i class="fas fa-lock text-3xl mb-3"></i><p>Vui lòng dang nh?p d? xem thông tin</p></div>'
    return
  }
  content.innerHTML = '<div class="bg-white rounded-2xl border p-4 space-y-3">'
    + '<h3 class="font-semibold text-gray-800 mb-3"><i class="fas fa-user-circle text-pink-400 mr-2"></i>Thông tin tài kho?n</h3>'
...
async function showUserOrders() {
  const content = document.getElementById('userMenuContent')
  if (!currentUser) {
    content.innerHTML = '<div class="text-center py-8 text-gray-400"><i class="fas fa-lock text-3xl mb-3"></i><p>Vui lòng dang nh?p d? xem l?ch s?</p></div>'
    return
  }
  ...
  try {
    ...
    if (!orders.length) {
      content.innerHTML = '<div class="text-center py-8 text-gray-400"><i class="fas fa-shopping-bag text-4xl mb-3"></i><p>Chua có don hàng nào</p></div>'
      return
    }
    content.innerHTML = '<h3 class="font-semibold text-gray-800 mb-3"><i class="fas fa-clipboard-list text-pink-400 mr-2"></i>L?ch s? mua hàng</h3>'
      + '<div class="space-y-2">' + orders.map(function(o) {
        ...
        const paymentBadgeText = paymentPaid ? 'Ðã thanh toán' : 'Chua thanh toán'
...
async function resumeOrderPayment(orderId, orderCode, paymentMethod) {
  ...
  try {
    ...
    if (paymentData.alreadyPaid) {
      ...
      showUserOrders()
      showToast('Ðon này dã thanh toán thành công', 'success', 3500)
      return
    }
    ...
    if (!checkoutUrl) {
      try { if (payTab && !payTab.closed) payTab.close() } catch (_) { }
      showToast('Không t?o du?c link thanh toán ' + providerLabel, 'error', 3500)
      return
    }
    if (!openCheckoutUrl(checkoutUrl)) {
      showToast('Trình duy?t dang ch?n popup, vui lòng cho phép m? tab m?i', 'warning', 3800)
      return
    }
    startOrderPaymentPolling(orderCode)
    showToast('Ðang m? l?i trang ' + providerLabel + ' d? b?n thanh toán ti?p', 'success', 3500)
  } catch (err) {
    const errCode = err.response?.data?.error
    ...
    if (errCode === 'PAYOS_CONFIG_MISSING') {
      showToast('PayOS chua c?u hình d?y d?, vui lòng liên h? shop', 'error', 5500)
      return
    }
    if (errCode === 'PAYMENT_METHOD_NOT_BANK_TRANSFER') {
      showToast('Ðon này không dùng phuong th?c chuy?n kho?n', 'error', 3800)
      return
    }
    if (errCode === 'ORDER_NOT_FOUND') {
      showToast('Không tìm th?y don hàng d? thanh toán l?i', 'error', 3800)
      return
    }
    if (errCode === 'INVALID_ORDER_AMOUNT') {
      showToast('Ðon hàng có s? ti?n không h?p l? d? thanh toán', 'error', 3800)
      return
    }
    try { if (payTab && !payTab.closed) payTab.close() } catch (_) { }
    const msg = err.response?.data?.error || err.message || 'Không th? m? l?i thanh toán cho don này'
    showToast('Không th? m? l?i thanh toán: ' + msg, 'error', 4000)
  }
}

// -- WALLET CONFIG (thay thông tin ngân hàng ? dây) --
const BANK_CONFIG = {
  bankId: 'MB',
...
async function copyBankValue(value) {
  try {
    ...
    showToast('Ðã sao chép', 'success', 1500)
  } catch (_) {
    showToast('Không th? sao chép', 'error', 1500)
  }
}
...
function onOrderMarkedPaid(orderCode) {
  ...
  showToast('Ðã thanh toán thành công và ghi nh?n don hàng', 'success', 4500)
  const userMenuContent = document.getElementById('userMenuContent')
  if (userMenuContent && userMenuContent.textContent && userMenuContent.textContent.includes('L?ch s? mua hàng')) {
    showUserOrders()
  }
...
function handlePaymentReturnFlow() {
  ...
  if (payState === 'cancel') {
    showToast('B?n dã h?y thanh toán ' + providerLabel, 'error', 3000)
  }
  cleanPaymentQueryParams()
}
...
function showWalletInMenu() {
    ...
    if (!currentUser) {
        content.innerHTML = '<div class="text-center py-8 text-gray-400"><i class="fas fa-lock text-3xl mb-3"></i><p>Vui lòng dang nh?p d? n?p ti?n</p></div>'
        return
    }
    ...
    html += '<div><p class="text-xs text-gray-500">S? du ví</p><p class="text-xl font-bold text-pink-600">' + fmtBalance(currentUser.balance) + '</p></div>'
    ...
    html += '</div>'
    html += '<div class="flex items-center gap-2 mb-4"><input id="customTopupAmt" type="number" placeholder="S? ti?n khác..." class="flex-1 border-2 border-gray-200 rounded-xl px-3 py-2 text-sm focus:border-pink-400 outline-none" oninput="onCustomAmountInput(this.value)"><span class="text-gray-400 text-sm font-semibold">d</span></div>'
    html += '<div class="bg-white border-2 border-gray-100 rounded-2xl p-4 text-center">'
    html += '<p class="text-sm font-semibold text-gray-700 mb-3"><i class="fas fa-qrcode text-pink-400 mr-1"></i>Quét mã QR d? thanh toán</p>'
    ...
    html += '<p class="font-semibold"><i class="fas fa-info-circle mr-1"></i>Luu ý:</p>'
    html += '<p>• N?i dung CK ph?i <strong>CHÍNH XÁC</strong></p>'
    html += '<p>• Ti?n s? du?c c?ng <strong>t? d?ng</strong> trong 1-5 phút</p>'
    html += '<p>• Liên h? admin n?u không nh?n du?c ti?n sau 10 phút</p>'
    html += '</div>'
...
function copyText(text) {
    navigator.clipboard.writeText(text).then(function () { showToast('Ðã sao chép: ' + text, 'success') })
}
...
function showTopupSuccessModal(amount) {
  ...
  overlay.innerHTML = '<div style="background:white;border-radius:1.5rem;padding:2.5rem 2rem;text-align:center;max-width:340px;width:90%;box-shadow:0 25px 50px rgba(0,0,0,0.25);animation:scaleIn 0.4s cubic-bezier(0.34,1.56,0.64,1)">'
    ...
    + '<h3 style="color:#059669;font-size:1.25rem;font-weight:700;margin-bottom:0.5rem">Ðã n?p ti?n thành công!</h3>'
