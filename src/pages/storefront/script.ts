...
function ensureHeroCarouselRuntimeStyle() {
  ...
  style.textContent = \`
    ...
    .hero-carousel-card{position:absolute;inset:0;border-radius:24px;overflow:hidden;background:radial-gradient(circle at 92% 12%,rgba(105,43,170,.35),transparent 38%) padding-box,linear-gradient(135deg,rgba(2,13,31,.99) 0%,rgba(4,15,38,.98) 58%,rgba(23,15,55,.96) 100%) padding-box,linear-gradient(135deg,rgba(85,222,252,.96) 0%,rgba(57,149,255,.56) 28%,rgba(139,85,255,.44) 58%,rgba(236,91,255,.98) 100%) border-box;color:#f8fbff;box-shadow:0 28px 70px rgba(0,0,0,.44),0 0 34px rgba(57,149,255,.18),0 0 36px rgba(236,91,255,.14),inset 0 0 0 1px rgba(255,255,255,.06),inset 0 1px 0 rgba(255,255,255,.08);border:1px solid transparent;transition:transform .55s cubic-bezier(.2,.8,.2,1),opacity .45s ease;will-change:transform,opacity;pointer-events:none;backface-visibility:hidden;-webkit-font-smoothing:antialiased}
